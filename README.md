...
Production-ready and tested Bicep templates are available in the [bicep-registry-modules](https://github.com/bicepregistry-modules) repo. Learn more about the templates on the Azure Verified Modules website: [https://aka.ms/bicep-registry-modules](https://aka.ms/bicep-registry-modules).
