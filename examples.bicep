...
//   - any
//   - Subresource arrays
param properties { autoUpgradeMinorVersion: bool, forceUpdateTag: string, instanceView: { name: string, statuses: InstanceViewStatus[], substatuses: InstanceViewStatus[], type: string, typeHandlerVersion: string }, protectedSettings: any, provisioningState: string, publisher: string, settings: any, type: string, typeHandlerVersion: string } = {
