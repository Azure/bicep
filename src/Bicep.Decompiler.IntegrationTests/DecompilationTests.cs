...
namespace Bicep.Core.IntegrationTests
{
    ...
    public class DecompilationTests
    {
        ...
        public void Decompiler_generates_expected_bicep_files_with_diagnostics(ExampleData example)
        {
            ...
            var decompiler = new TemplateDecompiler(nsProvider, new FileResolver(), BicepTestConstants.RegistryProvider, BicepTestConstants.ConfigurationManager, BicepTestConstants.ApiVersionProvider);
        ...
        public void Decompiler_raises_errors_for_unsupported_features(string resourcePath, string expectedMessage)
        {
            Action onDecompile = () => {
                ...
                var decompiler = new TemplateDecompiler(TestTypeHelper.CreateEmptyProvider(),
                                                        fileResolver,
                                                        new DefaultModuleRegistryProvider(fileResolver, BicepTestConstants.ClientFactory,BicepTestConstants.TemplateSpecRepositoryFactory, BicepTestConstants.Features),
