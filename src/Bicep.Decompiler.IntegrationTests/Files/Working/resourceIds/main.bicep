...
//@[22:45) [BCP081 (Warning)] Resource type "Foo.Rp/bar@2019-06-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (bicep https://aka.ms/bicep/core-diagnostics#BCP081) |'Foo.Rp/bar@2019-06-01'|
  name: '${fooName}blah'
  location: location
  dependsOn: [
    fooName_bar
...
//@[23:46) [BCP081 (Warning)] Resource type "Foo.Rp/bar@2019-06-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (bicep https://aka.ms/bicep/core-diagnostics#BCP081) |'Foo.Rp/bar@2019-06-01'|
  name: '${fooName}blah2'
  location: location
  properties: {
...
//@[04:29) [BCP034 (Error)] The enclosing array expected an item of type "module[] | (resource | module) | resource[]", but the provided item was of type "'Foo.Rp/barFoo!bar'". (bicep https://aka.ms/bicep/core-diagnostics#BCP034) |'Foo.Rp/bar${fooName}bar'|
  ]
}
