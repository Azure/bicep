...
//@[08:15) [decompiler-cleanup (Warning)] The symbolic name of resource 'name1_resource' appears to have originated from a naming conflict during a decompilation from JSON. Consider renaming it and removing the suffix (using the editor's rename functionality). (CodeDescription: Linter(https://aka.ms/bicep/linter/decompiler-cleanup)) |'name1'|
  ...
  properties: {
    val1: name1_var
//@[04:08) [BCP037 (Warning)] The property "val1" is not allowed on objects of type "ResourceGroupProperties". No other properties are allowed. If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP037)) |val1|
  }
}
...
//@[08:15) [decompiler-cleanup (Warning)] The symbolic name of resource 'naME2_resource' appears to have originated from a naming conflict during a decompilation from JSON. Consider renaming it and removing the suffix (using the editor's rename functionality). (CodeDescription: Linter(https://aka.ms/bicep/linter/decompiler-cleanup)) |'naME2'|
  ...
  properties: {
    val2: NamE2_var
//@[04:08) [BCP037 (Warning)] The property "val2" is not allowed on objects of type "ResourceGroupProperties". No other properties are allowed. If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP037)) |val2|
  }
}

output name1 string = name1_resource.properties.val1
//@[48:52) [BCP053 (Warning)] The type "ResourceGroupProperties" does not contain property "val1". Available properties include "provisioningState". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |val1|
output Name2 string = naME2_resource.properties.val2
//@[48:52) [BCP053 (Warning)] The type "ResourceGroupProperties" does not contain property "val2". Available properties include "provisioningState". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |val2|
