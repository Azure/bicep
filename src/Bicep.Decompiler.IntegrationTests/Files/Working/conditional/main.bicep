...
//@[13:36) [BCP081 (Warning)] Resource type "Foo.Rp/bar@2019-06-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (bicep https://aka.ms/bicep/core-diagnostics#BCP081) |'Foo.Rp/bar@2019-06-01'|
  name: 'baz'
  location: 'westus'
  dependsOn: [
    foo_bar
...
module module1Deploy 'nested/module1.json' = if ((1 + 2) == 3) {
  name: 'module1Deploy'
  params: {
//@[02:08) [BCP035 (Error)] The specified "object" declaration is missing the following required properties: "bar", "baz", "foo". (bicep https://aka.ms/bicep/core-diagnostics#BCP035) |params|
    location: location
//@[04:12) [BCP037 (Error)] The property "location" is not allowed on objects of type "params". Permissible properties include "bar", "baz", "foo", "qux". (bicep https://aka.ms/bicep/core-diagnostics#BCP037) |location|
    objectParam: objectVar
//@[04:15) [BCP037 (Error)] The property "objectParam" is not allowed on objects of type "params". Permissible properties include "bar", "baz", "foo", "qux". (bicep https://aka.ms/bicep/core-diagnostics#BCP037) |objectParam|
    arrayParam: arrayVar
//@[04:14) [BCP037 (Error)] The property "arrayParam" is not allowed on objects of type "params". Permissible properties include "bar", "baz", "foo", "qux". (bicep https://aka.ms/bicep/core-diagnostics#BCP037) |arrayParam|
  }
}
...
module module2Deploy 'nested/module2.json' = if ((1 + 2) == 3) {
  name: 'module2Deploy'
  params: {
//@[02:08) [BCP035 (Error)] The specified "object" declaration is missing the following required properties: "stringParam". (bicep https://aka.ms/bicep/core-diagnostics#BCP035) |params|
    location: location
//@[04:12) [BCP037 (Error)] The property "location" is not allowed on objects of type "params". Permissible properties include "stringParam". (bicep https://aka.ms/bicep/core-diagnostics#BCP037) |location|
    objectParam: objectVar
    arrayParam: arrayVar
  }
}
