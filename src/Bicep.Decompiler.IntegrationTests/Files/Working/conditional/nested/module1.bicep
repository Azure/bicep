...
param baz array
//@[6:9) [no-unused-params (Warning)] Parameter "baz" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |baz|
param qux string = 'xyzzy'
//@[6:9) [no-unused-params (Warning)] Parameter "qux" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |qux|
