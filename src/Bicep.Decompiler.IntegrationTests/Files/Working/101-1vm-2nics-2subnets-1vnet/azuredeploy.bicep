...
//@[26:32) [BCP036 (Warning)] The property "provisionVMAgent" expected a value of type "bool | null" but the provided value is of type "'true'". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP036)) |'true'|
      }
    }
    hardwareProfile: {
...
//@[20:66) [use-resource-symbol-reference (Warning)] Use a resource reference instead of invoking function "reference". This simplifies the syntax and allows Bicep to better understand your deployment dependency graph. (CodeDescription: Linter(https://aka.ms/bicep/linter/use-resource-symbol-reference)) |reference(diagStorageAccount.id, '2019-06-01')|
      }
    }
  }
}
