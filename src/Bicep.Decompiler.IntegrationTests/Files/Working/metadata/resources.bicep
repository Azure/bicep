...
//@[8:28) [simplify-interpolation (Warning)] Remove unnecessary string interpolation. (CodeDescription: Linter(https://aka.ms/bicep/linter/simplify-interpolation)) |'${afdEndpointName}'|
  location: 'Global'
  properties: {
