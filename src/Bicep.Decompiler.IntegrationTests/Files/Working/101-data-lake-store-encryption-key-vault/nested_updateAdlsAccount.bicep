...
resource dataLakeStore 'Microsoft.DataLakeStore/accounts@2016-11-01' = {
  ...
  properties: {
    encryptionConfig: {
//@[4:20) [BCP035 (Warning)] The specified "object" declaration is missing the following required properties: "type". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (bicep https://aka.ms/bicep/core-diagnostics#BCP035) |encryptionConfig|
      keyVaultMetaInfo: {
