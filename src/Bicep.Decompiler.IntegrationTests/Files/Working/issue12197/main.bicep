...
//@[53:55) [BCP053 (Error)] The type "module" does not contain property "id". Available properties include "name", "outputs". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |id|
...
//@[54:56) [BCP053 (Error)] The type "module" does not contain property "id". Available properties include "name", "outputs". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |id|
    appSettingsArray: [
      {
        name: 'APPINSIGHTS_INSTRUMENTATIONKEY'
        value: reference(appInsightsModule.id, '2022-09-01').outputs.appInsightsInstrumentationKey.value
//@[43:45) [BCP053 (Error)] The type "module" does not contain property "id". Available properties include "name", "outputs". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |id|
      }
      {
...
//@[44:46) [BCP053 (Error)] The type "module" does not contain property "id". Available properties include "name", "outputs". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP053)) |id|
  }
}
