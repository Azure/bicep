...
//@[42:92) [use-resource-symbol-reference (Warning)] Use a resource reference instead of invoking function "reference". This simplifies the syntax and allows Bicep to better understand your deployment dependency graph. (CodeDescription: Linter(https://aka.ms/bicep/linter/use-resource-symbol-reference)) |reference(app_appService.id, '2022-09-01', 'full')|
