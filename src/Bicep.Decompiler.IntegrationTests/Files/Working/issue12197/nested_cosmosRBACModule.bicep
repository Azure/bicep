...
//@[6:17) [no-unused-params (Warning)] Parameter "dataActions" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |dataActions|
...
//@[6:24) [no-unused-params (Warning)] Parameter "roleDefinitionName" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |roleDefinitionName|
...
//@[4:18) [no-unused-vars (Warning)] Variable "roleDefinition" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-vars) |roleDefinition|
  'sql-role-definition-',
  principalId,
  resourceId('Microsoft.DocumentDB/databaseAccounts', databaseAccountName)
)
