...
//@[44:87) [use-resource-symbol-reference (Warning)] Use a resource reference instead of invoking function "reference". This simplifies the syntax and allows Bicep to better understand your deployment dependency graph. (CodeDescription: Linter(https://aka.ms/bicep/linter/use-resource-symbol-reference)) |reference(ui_userIdentity.id, '2023-01-31')|
