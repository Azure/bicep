...
//@[26:29) [BCP085 (Error)] The specified file path contains one ore more invalid path characters. The following are not permitted: """, "*", ":", "<", ">", "?", "\", "|". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP085)) |'?'|
...
module moduleWithRg 'nested/module1.json' = {
  ...
  params: {}
//@[02:08) [BCP035 (Error)] The specified "object" declaration is missing the following required properties: "arrayParam", "location", "objectParam". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP035)) |params|
}
...
//@[09:42) [BCP134 (Error)] Scope "subscription" is not valid for this module. Permitted scopes: "resourceGroup". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP134)) |subscription('${module1Url}test')|
  params: {}
//@[02:08) [BCP035 (Error)] The specified "object" declaration is missing the following required properties: "arrayParam", "location", "objectParam". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP035)) |params|
}
