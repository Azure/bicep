...
//@[049:050) [BCP279 (Error)] Expected a type at this location. Please specify a valid type expression or one of the following types: "array", "bool", "int", "object", "string". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP279)) |?|
...
//@[138:218) [BCP174 (Warning)] Type validation is not available for resource types declared containing a "/providers/" segment. Please instead use the "scope" property. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP174)) |'Microsoft.Storage/storageAccounts/providers/roleAssignments@2018-09-01-preview'|
...
//@[146:226) [BCP174 (Warning)] Type validation is not available for resource types declared containing a "/providers/" segment. Please instead use the "scope" property. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP174)) |'Microsoft.Storage/storageAccounts/providers/roleAssignments@2018-09-01-preview'|
