...
//@[53:145) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. (bicep core linter https://aka.ms/bicep/linter/prefer-interpolation) |concat(\n  _doNotStripUnderscoresFromUserNames_,\n  _doNotStripUnderscoresFromUserNames__var\n)|
  _doNotStripUnderscoresFromUserNames_,
  _doNotStripUnderscoresFromUserNames__var
)
