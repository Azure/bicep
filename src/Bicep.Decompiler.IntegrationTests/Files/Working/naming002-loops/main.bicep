...
resource vm 'Microsoft.Compute/virtualMachines@2020-12-01' = [
  for i in range(0, 2): {
    ...
    zones: [
      (i + 1)
//@[6:13) [BCP034 (Warning)] The enclosing array expected an item of type "string", but the provided item was of type "int". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP034)) |(i + 1)|
    ]
    dependsOn: [
      nic
    ]
