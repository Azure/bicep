...
//@[66:78) [simplify-json-null (Warning)] Simplify json('null') to null (CodeDescription: Linter(https://aka.ms/bicep/linter/simplify-json-null)) |json('null')|
      }
      storageProfile: {
...
//@[06:66) [BCP034 (Error)] The enclosing array expected an item of type "module[] | (resource | module) | resource[]", but the provided item was of type "string". (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP034)) |resourceId('Microsoft.Network/networkInterfaces', 'nic${i}')|
      availabilitySet
    ]
  }
]
