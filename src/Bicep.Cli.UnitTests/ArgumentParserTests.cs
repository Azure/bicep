...
namespace Bicep.Cli.UnitTests
{
    ...
    public class ArgumentParserTests
    {
        ...
        [DataTestMethod]
        // build
        [DataRow(new[] { "build" }, "Either the input file path or the --file-pattern parameter must be specified")]
        [DataRow(new[] { "build", "foo.bicep", "--file-pattern", "*.bicep" }, "The input file path and the --file-pattern parameter cannot both be specified")]
        [DataRow(new[] { "build", "--file-pattern" }, "The --file-pattern parameter expects an argument")]
        [DataRow(new[] { "build", "--file-pattern", "*.bicep", "--stdout" }, "The --stdout parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build", "--file-pattern", "*.bicep", "--outdir", "foo" }, "The --outdir parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build", "--file-pattern", "*.bicep", "--outfile", "foo" }, "The --outfile parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build", "--stdout" }, "Either the input file path or the --file-pattern parameter must be specified")]
        ...
        // build-params
        [DataRow(new[] { "build-params" }, "Either the input file path or the --file-pattern parameter must be specified")]
        [DataRow(new[] { "build-params", "foo.bicepparam", "--file-pattern", "*.bicepparam" }, "The input file path and the --file-pattern parameter cannot both be specified")]
        [DataRow(new[] { "build-params", "--file-pattern" }, "The --file-pattern parameter expects an argument")]
        [DataRow(new[] { "build-params", "--file-pattern", "*.bicepparam", "--stdout" }, "The --stdout parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build-params", "--file-pattern", "*.bicepparam", "--outdir", "foo" }, "The --outdir parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build-params", "--file-pattern", "*.bicepparam", "--outfile", "foo" }, "The --outfile parameter cannot be used with the --file-pattern parameter")]
        [DataRow(new[] { "build-params", "--stdout" }, "Either the input file path or the --file-pattern parameter must be specified")]
        ...
        // restore
        [DataRow(new[] { "restore" }, "Either the input file path or the --file-pattern parameter must be specified")]
        [DataRow(new[] { "restore", "foo.bicep", "--file-pattern", "*.bicep" }, "The input file path and the --file-pattern parameter cannot both be specified")]
        [DataRow(new[] { "restore", "--file-pattern" }, "The --file-pattern parameter expects an argument")]
        ...
        // lint
        [DataRow(new[] { "lint" }, "Either the input file path or the --file-pattern parameter must be specified")]
        [DataRow(new[] { "lint", "foo.bicep", "--file-pattern", "*.bicep" }, "The input file path and the --file-pattern parameter cannot both be specified")]
        [DataRow(new[] { "lint", "--file-pattern" }, "The --file-pattern parameter expects an argument")]
        [DataRow(new[] { "lint", "--fake" }, "Unrecognized parameter \"--fake\"")]
        // format
        [DataRow(new[] { "format" }, "Either the input file path or the --file-pattern parameter must be specified")]
        [DataRow(new[] { "format", "foo.bicep", "--file-pattern", "*.bicep" }, "The input file path and the --file-pattern parameter cannot both be specified")]
        [DataRow(new[] { "format", "--file-pattern" }, "The --file-pattern parameter expects an argument")]
