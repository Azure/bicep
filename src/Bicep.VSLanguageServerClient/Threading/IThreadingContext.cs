...
{
    /// <summary>
    /// Provides a JoinableTaskContext" which Roslyn code can use for transitioning
    ...
    public interface IThreadingContext
    {
        ...
        /// <summary>
        /// Gets the JoinableTaskContext for use in Roslyn code.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JoinableTaskFactory for use in Roslyn code.
        /// </summary>
