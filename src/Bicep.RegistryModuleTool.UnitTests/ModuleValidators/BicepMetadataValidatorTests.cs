...
namespace Bicep.RegistryModuleTool.UnitTests.ModuleValidators
{
    ...
    public class BicepMetadataValidatorTests
    {
        ...
        [DataRow("a", null)]
        [DataRow("", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("StevieWeatherfjord", null)]
        [DataRow("Azure/StevieWeatherfjord", null)]
        [DataRow("Azurey/StevieWeatherfjord", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("/StevieWeatherfjord", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("StevieWeatherfjord/", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("a1-b-c-d-e", null)]
        [DataRow("Azure/a/a", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("Azure/זרוע", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("azure/a1-b-c-d-e", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("A1--b-c-d-e", "*\"metadata owner\" must match the following regex:*")]
        [DataRow("אנואוהבBicep", "*\"metadata owner\" must match the following regex:*")]
