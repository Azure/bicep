...
namespace Bicep.Core.RegistryClient.Models
{
    ...
    internal partial class ManifestWrapper : Manifest
    {
        ...
        internal ManifestWrapper(int schemaVersion, string mediaType, IReadOnlyList<ManifestListAttributes> manifests, Descriptor config, IReadOnlyList<Descriptor> layers, Annotations annotations, string architecture, string name, string tag, IReadOnlyList<FsLayer> fsLayers, IReadOnlyList<History> history, IReadOnlyList<ImageSignature> signatures) : base(schemaVersion, mediaType)
        {
            Manifests = manifests;
            Config = config;
            Layers = layers;
