...
namespace Bicep.Core.RegistryClient
{
    internal partial class ContainerRegistryRestClient
    {
        ...
        internal HttpMessage CreateCreateManifestRequest(string name, string reference, Models.ContentType contentType, Stream payload)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<ResponseWithHeaders<ContainerRegistryCreateManifestHeaders>> CreateManifestAsync(string name, string reference, Models.ContentType contentType, Stream payload, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/>, <paramref name="reference"/>, or <paramref name="payload"/> is null. </exception>
        public ResponseWithHeaders<ContainerRegistryCreateManifestHeaders> CreateManifest(string name, string reference, Models.ContentType contentType, Stream payload, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
