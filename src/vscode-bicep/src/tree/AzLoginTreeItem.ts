...
// export class AzLoginQuickPickItem implements IAzureQuickPickItem<() => void> {
//   public data: () => void; //asdfg

//   //asdfg public static contextValue = "azureextensionui.azureAccount";
//   //asdfg public readonly contextValue: string = AzLoginTreeItem.contextValue;
//   //asdfg public readonly label: string = "Azure";
//   //asdfg public childTypeLabel: string = localize("subscription", "subscription");
//  //asdfg  public autoSelectInTreeItemPicker = true;
//   //asdfg public suppressMaskLabel = true;

//   //asdfg private _azureAccountTask: Promise<AzureAccountResult>;


//  //asdfg ?? private _testAccount: AzureAccount | undefined;

//   constructor(/*asdfg parent?: AzExtParentTreeItem, testAccount?: AzureAccount*/) {
//     //asdfg
