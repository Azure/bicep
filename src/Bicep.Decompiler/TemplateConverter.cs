...
namespace Bicep.Decompiler
{
    public class TemplateConverter
    {
        ...
        public TemplateMetadataSyntax ParseTemplateMetadata(JProperty value)
        {
            return new TemplateMetadataSyntax(
                SyntaxFactory.CreateToken(TokenType.Identifier, "templateMetadata"),
        ...
        private ProgramSyntax Parse()
        {
            ...
            var templateMetadata = (TemplateHelpers.GetProperty(template, "metadata")?.Value as JObject ?? new JObject()).Properties();
            ...
            AddSyntaxBlock(statements, templateMetadata.Where(x => x.Name != "_generator").Select(ParseTemplateMetadata), false);
