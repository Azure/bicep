...
public class BicepDecompiler
{
    ...
    /// <summary>
    /// Returns true if the JSON content was generated by Bicep (i.e. has metadata._generator.name == "bicep").
    /// Decompiling such a template is sub-optimal because information is lost during Bicep -> JSON compilation.
    /// </summary>
    public static bool IsBicepGeneratedTemplate(string jsonContent)
    {
        try
        {
