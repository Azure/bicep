...
namespace Bicep.Wasm
{
    public class Interop
    {
        ...
        private static readonly IApiVersionProvider apiVersionProvider = new ApiVersionProvider(namespaceProvider);
        ...
        public DecompileResult Decompile(string jsonContent)
        {
            ...
            try
            {
                ...
                var decompiler = new TemplateDecompiler(namespaceProvider, fileResolver, new EmptyModuleRegistryProvider(), new ConfigurationManager(new IOFileSystem()), apiVersionProvider);
        ...
        private static Compilation GetCompilation(string fileContents)
        {
            ...
            return new Compilation(namespaceProvider, sourceFileGrouping, configuration, apiVersionProvider);
        }
