...
{
    protected override async Task<int> RunInternal(TeardownArguments args, Compilation compilation, SemanticModel model, ParametersResult parameters, CancellationToken cancellationToken)
    {
    ...
    protected override Task<int> RunOrchestrationInternal(TeardownArguments args, Compilation compilation, SemanticModel model, CancellationToken cancellationToken)
    {
