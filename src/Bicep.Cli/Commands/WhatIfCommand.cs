    ...
    InputOutputArgumentsResolver inputOutputArgumentsResolver) : ICommand
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        (parameters, var scope, var deploymentName) = await DeploymentProcessor.ProcessParameters(environment, args, parameters);

        var deploymentResource = armClient.GetArmDeploymentResource(new ResourceIdentifier($"{scope}/providers/Microsoft.Resources/deployments/{deploymentName}"));
