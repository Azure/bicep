    ...
    public static class ArgumentParser
    {
        public static ArgumentsBase? TryParse(string[] args, IOContext io, IFileSystem fileSystem)
        {
            ...
            return (args[0].ToLowerInvariant()) switch
            {
                ...
                Constants.Command.PublishProvider => new PublishProviderArguments(args[1..], Constants.Command.PublishProvider, io),
                Constants.Command.PublishExtension => new PublishProviderArguments(args[1..], Constants.Command.PublishExtension, io),
