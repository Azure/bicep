        ...
        public async Task<int> RunAsync(string[] args, CancellationToken cancellationToken)
        {
            ...
            try
            {
                switch (ArgumentParser.TryParse(args, this.io))
                {
                    ...
                    case PublishProviderArguments publishProviderArguments when publishProviderArguments.CommandName == Constants.Command.PublishProvider: // bicep publish [options]
