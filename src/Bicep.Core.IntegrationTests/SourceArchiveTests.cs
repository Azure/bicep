...
namespace Bicep.Core.IntegrationTests
{
    ...
    public class SourceArchiveTests : TestBase
    {
            ...
            sourceArchive.Should().HaveMetadataAndFiles($$"""
                {
                  ...
                  "sourceFiles": [
                    ...
                    {
                      "path": "<cache>/br/localhost/test$module1/v1$/main.json",
                      "archivePath": "files/_cache_/br/localhost/test$module1/v1$/main.json",
                      "kind": "ArmTemplate",
                      "sourceArtifactId": null
                    },
                    {
                      "path": "<cache>/br/localhost/test$module2/v2$/main.json",
                      "archivePath": "files/_cache_/br/localhost/test$module2/v2$/main.json",
                      "kind": "ArmTemplate",
                      "sourceArtifactId": "br:localhost/test/module2:v2"
                    }
                  ],
                  "documentLinks": {
                    "main.bicep": [
                ...
                ("files/_cache_/br/localhost/test$module1/v1$/main.json", bicepRegistryModule1Template.ToString(Newtonsoft.Json.Formatting.Indented)),
                ("files/_cache_/br/localhost/test$module2/v2$/main.json", bicepRegistryModule2Template.ToString(Newtonsoft.Json.Formatting.Indented)));
        }
        ...
        public async Task CreateFrom_WithExtension_IgnoresExtensionArtifact()
        {
            ...
            await this.artifactManager.PublishRegistryModules(new RegistryModulePublishArguments("br:localhost/test/module1:v1", "param p1 bool", WithSource: true));
            ...
            using (new AssertionScope())
            {
                ...
                sourceArchive.FindSourceFile("<cache>/br/localhost/test$module1/v1$/main.json").Metadata.SourceArtifactId.Should().Be("br:localhost/test/module1:v1");
            }
        ...
        public async Task CreateFrom_WithReferencesToSameModules_HandlesSameReferencesProperly()
        {
            ...
            await this.artifactManager.PublishRegistryModules(
                ...
                new("br:localhost/test/module2:v1", "param p2 string", WithSource: true),
                new("br:localhost/test/module1:v2", "param p12 string", WithSource: true));
            ...
            var sourceFileGrouping = await this.CreateSourceFileGrouping(
                ("main.bicep", """
                    ...
                    module m1b 'br:localhost/test/module1:v1' = {
                        params: {
                            p1: false
                      }
                    }
                    ...
                    module m12 'br:localhost/test/module1:v2' = {
                        params: {
                            p12: 'p12'
                      }
                    }
                ...
                ("local.bicep", """
                    ...
                    module m2 'br:localhost/test/module2:v1' = {
                        params: {
                            p2: 'p2'
                      }
                    }
            ...
            using (new AssertionScope())
            {
                sourceArchive.FindSourceFile("main.bicep").Metadata.SourceArtifactId.Should().BeNull();
                sourceArchive.FindSourceFile("<cache>/br/localhost/test$module1/v1$/main.json").Metadata.SourceArtifactId.Should().Be("br:localhost/test/module1:v1");
                sourceArchive.FindSourceFile("<cache>/br/localhost/test$module1/v2$/main.json").Metadata.SourceArtifactId.Should().Be("br:localhost/test/module1:v2");
                sourceArchive.FindSourceFile("<cache>/br/localhost/test$module2/v1$/main.json").Metadata.SourceArtifactId.Should().Be("br:localhost/test/module2:v1");
        ...
        public async Task CreateFrom_WithNotResolvedModules_IgnoresThoseModules()
        {
            ...
            await this.artifactManager.PublishRegistryModule("br:localhost/test/module1:v1", "param p1 bool", withSource: true);
            ...
            var mainBicepText = """
                ...
                module m2 'br:localhost/test/module2:v1' = { // not found
                    params: {
                        p1: true
                  }
                }
            ...
            sourceArchive.Should().HaveMetadataAndFiles($$"""
                {
                  ...
                  "sourceFiles": [
                    ...
                    },
                    {
                      ...
                      "archivePath": "files/_cache_/br/localhost/test$module1/v1$/main.json",
                      "kind": "ArmTemplate",
                      "sourceArtifactId": "br:localhost/test/module1:v1"
                    }
                  ],
                  "documentLinks": {
                    "main.bicep": [
                ...
                ("files/_cache_/br/localhost/test$module1/v1$/main.json", moduleTemplateText));
        }
        ...
        private static class SampleData
        {
            ...
            public const string BicepRegistryModule1ArtifactId = "br:localhost/test/module1:v1";
            public const string BicepRegistryModule1Text = """
                param brm1 string
                """;

            public const string BicepRegistryModule2ArtifactId = "br:localhost/test/module2:v2";
