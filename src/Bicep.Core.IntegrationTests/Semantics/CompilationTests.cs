...
namespace Bicep.Core.IntegrationTests.Semantics
{
    ...
    public class CompilationTests
    {
        ...
        public void EmptyProgram_SourceFileGrouping_should_be_persisted()
        {
            ...
            var compilation = new Compilation(TestTypeHelper.CreateEmptyProvider(), program, BicepTestConstants.BuiltInConfiguration, BicepTestConstants.ApiVersionProvider);
