...
namespace Bicep.Core.IntegrationTests.Semantics
{
    ...
    public class SemanticModelTests
    {
        ...
        {
            var compilation = CompilationHelper.CreateCompilation(SourceFileGroupingFactory.CreateFromText("parameter ", BicepTestConstants.FileResolver));
...
resource test";
            ...
            var compilation = CompilationHelper.CreateCompilation(SourceFileGroupingFactory.CreateForFiles(files, uri, BicepTestConstants.FileResolver, BicepTestConstants.BuiltInConfiguration));
