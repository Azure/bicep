...
namespace Bicep.Core.IntegrationTests.Semantics
{
    ...
    public class ParamsSemanticModelTests
    {
        ...
        private ParamsSemanticModel CreateSemanticModel(string paramsFilePath)
        {
            ...
            var compilation = new Compilation(BicepTestConstants.Features, TestTypeHelper.CreateEmptyProvider(), sourceFileGrouping, IConfigurationManager.ForConfiguration(configuration), BicepTestConstants.ApiVersionProvider, BicepTestConstants.LinterAnalyzer);
            ...
            return new ParamsSemanticModel(sourceFileGrouping, configuration, BicepTestConstants.Features, file => {
                ...
                return new Compilation(BicepTestConstants.Features, BicepTestConstants.NamespaceProvider, compilationGrouping, IConfigurationManager.ForConfiguration(configuration), BicepTestConstants.ApiVersionProvider, BicepTestConstants.LinterAnalyzer);
            });
        }
