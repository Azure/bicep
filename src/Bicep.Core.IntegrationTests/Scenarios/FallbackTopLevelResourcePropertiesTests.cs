...
namespace Bicep.Core.IntegrationTests.Scenarios
{
    ...
    {
        private static Compilation CreateCompilation(string program) => new(BuiltInTestTypes.Create(), SyntaxTreeGroupingFactory.CreateFromText(program, new Mock<IFileResolver>(MockBehavior.Strict).Object));
