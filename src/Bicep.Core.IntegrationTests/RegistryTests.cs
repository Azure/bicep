...
namespace Bicep.Core.IntegrationTests
{
    ...
    public class RegistryTests
    {
        ...
        public async Task InvalidRootCachePathShouldProduceReasonableErrors()
        {
            ...
            var dispatcher = new ModuleDispatcher(new DefaultModuleRegistryProvider(BicepTestConstants.FileResolver, clientFactory, templateSpecRepositoryFactory, featureManager, BicepTestConstants.ConfigurationManager), BicepTestConstants.ConfigurationManager);
            ...
            var compilation = new Compilation(featureManager, BicepTestConstants.NamespaceProvider, sourceFileGrouping, BicepTestConstants.ConfigurationManager, BicepTestConstants.ApiVersionProvider, BicepTestConstants.LinterAnalyzer);
        ...
        public async Task ModuleRestoreContentionShouldProduceConsistentState()
        {
            ...
            var dispatcher = new ModuleDispatcher(new DefaultModuleRegistryProvider(new FileResolver(), clientFactory, templateSpecRepositoryFactory, IFeatureProviderManager.ForFeatureProvider(features.Object), configManager), configManager);
        ...
        public async Task ModuleRestoreWithStuckFileLockShouldFailAfterTimeout(IEnumerable<ExternalModuleInfo> moduleInfos, int moduleCount)
        {
            ...
            var configManager = IConfigurationManager.ForConfiguration(BicepTestConstants.BuiltInConfigurationWithAllAnalyzersDisabled);
            var dispatcher = new ModuleDispatcher(new DefaultModuleRegistryProvider(fileResolver, clientFactory, templateSpecRepositoryFactory, IFeatureProviderManager.ForFeatureProvider(features.Object), configManager), configManager);
