...
",
            ...
            var compilationResult = CompilationHelper.Compile(mainUri, files);
            var diagnosticsByFile = compilationResult.Compilation.GetAllDiagnosticsByBicepFile().ToDictionary(kvp => kvp.Key.FileUri, kvp => kvp.Value);
