...
";
        ...
        {
            var context = new CompilationHelper.CompilationHelperContext(Features: BicepTestConstants.CreateFeatureProvider(this.TestContext, symbolicNameCodegenEnabled: symbolicNameCodegenEnabled));
