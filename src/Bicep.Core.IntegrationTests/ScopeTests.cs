...
".Replace("TARGET_SCOPE", targetScope)));
        ...
        {
            var context = new CompilationHelper.CompilationHelperContext(Features: BicepTestConstants.CreateFeatureProvider(this.TestContext, symbolicNameCodegenEnabled: true));
