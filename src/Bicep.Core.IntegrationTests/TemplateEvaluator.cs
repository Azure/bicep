    ...
    public class TemplateEvaluator
    {
        ...
        private static JToken EvaluateTemplate(JToken? templateJtoken, EvaluationConfiguration config)
        {
            ...
            try
            {
                ...
                TemplateEngine.ValidateTemplate(template, "2020-09-01", deploymentScope);
                ...
                TemplateEngine.ProcessTemplateLanguageExpressions(config.ManagementGroup, config.SubscriptionId, config.ResourceGroup, template, "2020-09-01");

                ProcessTemplateLanguageExpressions(template, config, deploymentScope);

                TemplateEngine.ValidateProcessedTemplate(template, "2020-09-01", deploymentScope);
