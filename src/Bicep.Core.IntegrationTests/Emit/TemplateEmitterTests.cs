...
";
        ...
        {   
            var model = new ParamsSemanticModel(SourceFileFactory.CreateBicepParamFile(PathHelper.FilePathToFileUrl(inputFilePath), File.ReadAllText(inputFilePath)), null, new ImmutableArray<IDiagnostic>());
