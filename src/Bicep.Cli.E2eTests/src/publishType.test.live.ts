...
describe("bicep publish-type", () => {
  ...
  it("should publish valid module", () => {
    ...
    invokingBicepCommand("publish-type", exampleFilePath, "--target", target)
  ...
  it("should publish valid module with alias", () => {
    ...
    invokingBicepCommand("publish-type", exampleFilePath, "--target", target, "--force")
      .withEnvironmentOverrides(environment.environmentOverrides)
      .shouldSucceed();
  });
