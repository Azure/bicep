...
namespace Bicep.Local.Extension.UnitTests.HostTests.TypeDefinitionBuilderTests.Types_A
{
...
namespace Bicep.Local.Extension.UnitTests.HostTests.TypeDefinitionBuilderTests.Types_B
{
    [BicepType(IsActive = true)]
    public class ActiveResource { }
...
namespace Bicep.Local.Extension.UnitTests.HostTests.TypeDefinitionBuilderTests
{
    ...
    public class TypeProviderTests
    {
        ...
        public void GetResourceTypes_Only_Returns_Public_Active_Types()
        {
            ...
            types.Should().NotContain(typeof(Types_A.InactiveResource));
