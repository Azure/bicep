    ...
    public class NoHardcodedLocationRuleTests : LinterRuleTestsBase
    {
        ...
        */
        ...
        public void If_ResLocationIs_AnyOtherStringLiteral_ShouldFail()
        {
            ...
            {
                (NoHardcodedLocationRule.Code, DiagnosticLevel.Warning, "A resource location should not use a hard-coded string or variable value. Please use a parameter value, an expression, or the string 'global'. Found: 'non-global'")
        ...
        public void ForLoop2_Module()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
                (NoHardcodedLocationRule.Code, DiagnosticLevel.Warning, "Parameter 'location' may be used as a resource location in the module and should not use a hard-coded string or variable value. Please use a parameter value, an expression, or the string 'global'. Found: 'westus'")
            });
        }
