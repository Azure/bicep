...
namespace Bicep.Core.UnitTests.Diagnostics.LinterRuleTests
{
    ...
    public class ExplicitValuesForLocationParamsRuleTests : LinterRuleTestsBase
    {
        ...
        public void If_ModuleHas_LocationParam_WithRGLocationDefault_AndValueNotPassedIn_ShouldFail()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p1' of module 'm3' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
            });
        }
        ...
        public void If_ModuleHas_LocationParams_WithRGLocationDefault_AndValuesNotPassedIn_ShouldFail()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
              ...
              (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p1' of module 'm3' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
              (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p2' of module 'm3' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),});
        }
        ...
        public void If_ModuleHas_LocationParams_UsedInResourceLocation_WithDefaultValues_AndValuesNotPassedIn_ShouldFail()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
              ("BCP035", DiagnosticLevel.Error, "The specified \"object\" declaration is missing the following required properties: \"pWithNoDefault\"."),
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p1' of module 'm' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p2' of module 'm' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p3' of module 'm' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'p4' of module 'm' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
             });
        }
        ...
        public void If_ModuleHas_LocationParam_WithDeploymentLocDefault_AndValueNotPassedIn_CaseInsensitive_ShouldFail()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'myParam' of module 'm1' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
        ...
        public void ForLoop3_Module()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning,  "Parameter 'location' of module 'm2' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
            });
        }
        ...
        public void Conditional1_Module()
        {
            ...
            result.Diagnostics.Should().HaveDiagnostics(new[]
            {
                (ExplicitValuesForLocationParamsRule.Code, DiagnosticLevel.Warning, "Parameter 'location' of module 'm3' isn't assigned an explicit value, and its default value may not be the intended behavior for a location-related parameter. You should assign an explicit value to the parameter."),
            });
        }
    }
}
