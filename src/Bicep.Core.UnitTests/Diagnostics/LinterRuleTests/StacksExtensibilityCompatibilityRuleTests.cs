...
namespace Bicep.Core.UnitTests.Diagnostics.LinterRuleTests
{
    ...
    public class StacksExtensibilityCompatibilityRuleTests : LinterRuleTestsBase
    {
        ...
        public async Task Provides_diagnostic_for_stacks_incompatible_assignments(string scenario, string extConfigAssignments, string moduleBody)
        {
            ...
            diagByFileUri[paramsUri].Should().ContainSingleDiagnostic("stacks-extensibility-compat", DiagnosticLevel.Info, "MESSAGE");
            diagByFileUri[mainUri].Should().ContainSingleDiagnostic("stacks-extensibility-compat", DiagnosticLevel.Info, "MESSAGE");
        }
