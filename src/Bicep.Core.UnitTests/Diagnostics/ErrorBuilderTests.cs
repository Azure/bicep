...
namespace Bicep.Core.UnitTests.Diagnostics
{
    ...
    public class DiagnosticBuilderTests
    {
        ...
        private class PrimitiveType(string name, TypeSymbolValidationFlags validationFlags) : TypeSymbol(name)
        {
            public override TypeKind TypeKind => TypeKind.Primitive;

            public override TypeSymbolValidationFlags ValidationFlags { get; } = validationFlags;
        }
    }
}
