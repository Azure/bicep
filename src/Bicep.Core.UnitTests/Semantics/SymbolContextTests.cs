...
namespace Bicep.Core.UnitTests.Semantics
{
    ...
    public class SymbolContextTests
    {
        ...
        public void LockedModeShouldBlockAccess()
        {
            ...
            var compilation = new Compilation(BicepTestConstants.FeatureProviderManager, TestTypeHelper.CreateEmptyProviderManager(), SourceFileGroupingFactory.CreateFromText("", BicepTestConstants.FileResolver), BicepTestConstants.BuiltInOnlyConfigurationManager, BicepTestConstants.ApiVersionProviderManager, BicepTestConstants.LinterAnalyzer);
