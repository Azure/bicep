...
namespace Bicep.Core.UnitTests.Registry
{
   ...
   ""annotations"": {
            ...
            var description = await OciArtifactRegistry.TryGetDescription(null!, OciArtifactReference);
     ...
     daprComponentScopes: [
       'nodeapp'
        ...
        public async Task GetDescription_WithNonExistentManifestFile_ShouldReturnNull()
        {
            ...
            var result = await OciArtifactRegistry.TryGetDescription(null!, OciArtifactReference);
   ...
   ""annotations"": {
     ...
     ""org.opencontainers.image.description"": """ + description + @"""
            ...
            var actualDescription = await OciArtifactRegistry.TryGetDescription(null!, OciArtifactReference);
