...
namespace Bicep.Core.UnitTests.Modules
{
    ...
    public class LocalModuleReferenceTests
    {
        ...
        {
            LocalModuleReference.TryParse(BicepTestConstants.FileExplorer, BicepTestConstants.DummyBicepFile, ArtifactType.Module, package).IsSuccess(out var parsed, out var failureBuilder);
