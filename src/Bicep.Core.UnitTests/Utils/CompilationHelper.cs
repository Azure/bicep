...
namespace Bicep.Core.UnitTests.Utils
{
    public static class CompilationHelper
    {
        ...
        public static CompilationResult Compile(Uri entryUri, IReadOnlyDictionary<Uri, string> bicepFiles, CompilationHelperContext? context = null)
        {
            ...
            return Compile(context, new Compilation(context.Features ?? BicepTestConstants.Features, context.GetNamespaceProvider(), sourceFileGrouping, IConfigurationManager.ForConfiguration(configuration), BicepTestConstants.ApiVersionProvider, BicepTestConstants.LinterAnalyzer));
        }
        ...
        public static CompilationResult Compile(CompilationHelperContext context, params (string fileName, string fileContents)[] files)
        {
            ...
            return Compile(context, new Compilation(context.Features ?? BicepTestConstants.Features, context.GetNamespaceProvider(), sourceFileGrouping, IConfigurationManager.ForConfiguration(configuration), apiVersionProvider, BicepTestConstants.LinterAnalyzer));
        }
        ...
        public static ParamsCompilationResult CompileParams(Uri entryUri, IReadOnlyDictionary<Uri, string> bicepFiles, CompilationHelperContext? context = null)
        {
            ...
            var model = new ParamsSemanticModel(sourceFileGrouping, configuration, context.GetFeatures(), file => {
                ...
                return new Compilation(context.GetFeatures(), context.GetNamespaceProvider(), compilationGrouping, IConfigurationManager.ForConfiguration(configuration), apiVersionProvider, new LinterAnalyzer());
            });
