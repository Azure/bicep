...
public static class ExtensionTestHelper
{
    ...
    {
        var reference = OciArtifactReference.TryParse(BicepTestConstants.FileExplorer, BicepTestConstants.DummyBicepFile.Configuration, ArtifactType.Module, null, target).Unwrap();
