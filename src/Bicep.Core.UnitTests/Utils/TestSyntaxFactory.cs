...
namespace Bicep.Core.UnitTests.Utils
{
    public static class TestSyntaxFactory
    {
        ...
        public static Token CreateToken(TokenType type) => new(type, TextSpan.Nil, [], []);

        public static FreeformToken CreateToken(TokenType type, string text) => new(type, TextSpan.Nil, text, [], []);
