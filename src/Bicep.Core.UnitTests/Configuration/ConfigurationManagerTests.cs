    ...
    public class ConfigurationManagerTests
    {
      ...
      """);
        ...
        public void GetConfiguration_CustomConfigurationNotFound_ReturnsBuiltInConfiguration()
        {
            ...
            // Act.
            var configuration = sut.GetMergedConfiguration(sourceFileUri);
        ...
        public void GetConfiguration_InvalidCustomConfiguration_PropagatesFailedToParseConfigurationDiagnostic()
        {
            ...
            // Act & Assert.
            var diagnostics = sut.GetMergedConfiguration(fileSet.GetUri("main.bicep")).GetDiagnostics().ToImmutableArray();
        ...
        public void GetConfiguration_ConfigurationFileNotReadable_PropagatesCouldNotLoadConfigurationDiagnostic()
        {
            ...
            // Act & Assert.
            var diagnostics = sut.GetMergedConfiguration(mainFileUri).GetDiagnostics().ToImmutableArray();
            diagnostics.Length.Should().Be(1);
            diagnostics[0].Level.Should().Be(DiagnosticLevel.Error);
        ...
        public void GetConfiguration_IOExceptionWhenDiscoveringConfiguration_ReturnsDefaultConfigurationWithInfoDiagnostic()
        {
            ...
            var sut = new BicepConfigurationManager(fileExplorer);
            var configuration = sut.GetMergedConfiguration(new IOUri(IOUriScheme.File, "", "/foo/bar/main.bicep"));
        ...
        public void GetConfiguration_ValidCustomConfiguration_OverridesBuiltInConfiguration(string root)
        {
            ...
            // Act.
            var configuration = sut.GetMergedConfiguration(fileSet.GetUri("modules/vnet.bicep"));
        ...
        public void Bicepconfig_resolution_is_a_merge_between_closest_bicepconfig_file_and_builtin_config()
        {
            ...
            // Act.
            var configuration = sut.GetMergedConfiguration(fileSet.GetUri("repo/modules/bicepconfig.json"));
        ...
        public void GetConfiguration_ModuleAliasesMock_SupersedesModuleAliasesForSameAlias()
        {
            ...
            // Act.
            var configuration = sut.GetMergedConfiguration(fileSet.GetUri("main.bicep"));
