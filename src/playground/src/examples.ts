...
import example_101_aci_linuxcontainer_public_ip from '../../../docs/examples/101/aci-linuxcontainer-public-ip/main.bicep'
...
import example_101_api_management_create_with_msi from '../../../docs/examples/101/api-management-create-with-msi/main.bicep'
import example_101_app_config from '../../../docs/examples/101/app-config/main.bicep'
import example_101_application_gateway_v2_autoscale_create from '../../../docs/examples/101/application-gateway-v2-autoscale-create/main.bicep'
import example_101_azure_search_create from '../../../docs/examples/101/azure-search-create/main.bicep'
import example_101_basic_publicip from '../../../docs/examples/101/basic-publicip/main.bicep'
import example_101_cognitive_services from '../../../docs/examples/101/cognitive-services/main.bicep'
...
import example_101_custom_role_definition_assignment from '../../../docs/examples/101/custom-role-definition-assignment/main.bicep'
import example_101_cyclecloud from '../../../docs/examples/101/cyclecloud/main.bicep'
import example_101_data_factory_v2 from '../../../docs/examples/101/data-factory-v2/main.bicep'
import example_101_data_factory_v2_blob_to_blob_copy from '../../../docs/examples/101/data-factory-v2-blob-to-blob-copy/main.bicep'
import example_101_data_lake_store_encryption_adls from '../../../docs/examples/101/data-lake-store-encryption-adls/main.bicep'
...
import example_101_deployment_script_no_auth from '../../../docs/examples/101/deployment-script-no-auth/main.bicep'
import example_101_deployment_script_with_storage from '../../../docs/examples/101/deployment-script-with-storage/main.bicep'
import example_101_expressroute_circuit_create from '../../../docs/examples/101/expressroute-circuit-create/main.bicep'
...
import example_101_function_premium_vnet_integration from '../../../docs/examples/101/function-premium-vnet-integration/main.bicep'
import example_101_hub_and_spoke from '../../../docs/examples/101/hub-and-spoke/main.bicep'
...
import example_101_sql_database from '../../../docs/examples/101/sql-database/main.bicep'
...
import example_101_webapp_privateendpoint_vnet_injection from '../../../docs/examples/101/webapp-privateendpoint-vnet-injection/main.bicep'
...
import example_201_proximity_placement_with_multi_resource_groups from '../../../docs/examples/201/proximity-placement-with-multi-resource-groups/main.bicep'
import example_201_servicebus_create_queue from '../../../docs/examples/201/servicebus-create-queue/main.bicep'
import example_201_sql from '../../../docs/examples/201/sql/main.bicep'
import example_201_vm_domain_join from '../../../docs/examples/201/vm-domain-join/main.bicep'
...
import example_201_vmss_windows_autoscale from '../../../docs/examples/201/vmss-windows-autoscale/main.bicep'
...
import example_201_web_app_sql_database from '../../../docs/examples/201/web-app-sql-database/main.bicep'
import example_201_wvd_backplane_with_network_and_storage_and_monitoring from '../../../docs/examples/201/wvd-backplane-with-network-and-storage-and-monitoring/main.bicep'
...
import example_301_servicebus_namespace_vnet from '../../../docs/examples/301/servicebus-namespace-vnet/main.bicep'
...
export const examples = {
  ...
  '101/aci-linuxcontainer-public-ip': example_101_aci_linuxcontainer_public_ip,
  '101/aks': example_101_aks,
  '101/aks-vmss-systemassigned-identity': example_101_aks_vmss_systemassigned_identity,
  '101/api-management-create-with-msi': example_101_api_management_create_with_msi,
  '101/app-config': example_101_app_config,
  '101/application-gateway-v2-autoscale-create': example_101_application_gateway_v2_autoscale_create,
  '101/azure-search-create': example_101_azure_search_create,
  '101/basic-publicip': example_101_basic_publicip,
  '101/cognitive-services': example_101_cognitive_services,
  ...
  '101/custom-role-definition-assignment': example_101_custom_role_definition_assignment,
  '101/cyclecloud': example_101_cyclecloud,
  '101/data-factory-v2': example_101_data_factory_v2,
  '101/data-factory-v2-blob-to-blob-copy': example_101_data_factory_v2_blob_to_blob_copy,
  '101/data-lake-store-encryption-adls': example_101_data_lake_store_encryption_adls,
  ...
  '101/deployment-script-no-auth': example_101_deployment_script_no_auth,
  '101/deployment-script-with-storage': example_101_deployment_script_with_storage,
  '101/expressroute_circuit_create': example_101_expressroute_circuit_create,
  ...
  '101/function-premium-vnet-integration': example_101_function_premium_vnet_integration,
  '101/hub-and-spoke': example_101_hub_and_spoke,
  ...
  '101/sql-database': example_101_sql_database,
  ...
  '101/webapp-privateendpoint-vnet-injection': example_101_webapp_privateendpoint_vnet_injection,
  ...
  '201/proximity-placement-with-multi-resource-groups/main.bicep': example_201_proximity_placement_with_multi_resource_groups,
  '201/servicebus-create-queue/main.bicep': example_201_servicebus_create_queue,
  '201/sql': example_201_sql,
  '201/vm-domain-join': example_201_vm_domain_join,
  ...
  '201/vmss-windows-autoscale': example_201_vmss_windows_autoscale,
  ...
  '201/web-app-sql-database': example_201_web_app_sql_database,
  '201/wvd-backplane-with-network-and-storage-and-monitoring': example_201_wvd_backplane_with_network_and_storage_and_monitoring,
  ...
  '301/servicebus-namespace-vnet': example_301_servicebus_namespace_vnet,
