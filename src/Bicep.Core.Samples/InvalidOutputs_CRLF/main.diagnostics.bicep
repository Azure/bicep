...
output i int = 'test'
//@[7:8) Error Identifier 'i' is declared multiple times. Remove or rename the duplicates. |i|
//@[15:21) Error The output expects a value of type 'int' but the provided value is of type 'string'. |'test'|
...
output b bool = 'str'
//@[7:8) Error Identifier 'b' is declared multiple times. Remove or rename the duplicates. |b|
//@[16:21) Error The output expects a value of type 'bool' but the provided value is of type 'string'. |'str'|
...
//@[7:10) Error Identifier 'arr' is declared multiple times. Remove or rename the duplicates. |arr|
//@[19:24) Error The output expects a value of type 'array' but the provided value is of type 'string'. |'str'|
...
output o object = 'str'
//@[7:8) Error Identifier 'o' is declared multiple times. Remove or rename the duplicates. |o|
//@[18:23) Error The output expects a value of type 'object' but the provided value is of type 'string'. |'str'|
...
//@[22:36) Error The output expects a value of type 'string' but the provided value is of type 'int | string'. |true ? 's' : 1|
...
//@[37:46) Error Cannot apply operator '&&' to operands of type 'int' and 'string'. |14 && 's'|
