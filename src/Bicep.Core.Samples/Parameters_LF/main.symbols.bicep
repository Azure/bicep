...
//@[6:16) Parameter storageSku. Type: 'Standard_GRS' | 'Standard_LRS'. Declaration start char: 0, length: 84
  allowed: [
    'Standard_LRS'
    'Standard_GRS'
  ]
...
//@[6:19) Parameter someParameter. Type: 'one' | 'three' | 'two'. Declaration start char: 0, length: 209
  secure: true
  minLength: 3
  maxLength: 24
  default: 'one'
