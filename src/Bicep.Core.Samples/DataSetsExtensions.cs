...
namespace Bicep.Core.Samples
{
    public static class DataSetsExtensions
    {
        ...
        public static async Task PublishModulesToRegistryAsync(ImmutableDictionary<string, DataSet.ExternalModuleInfo> registryModules, IContainerRegistryClientFactory clientFactory, bool publishSource = true)
        {
            foreach (var (moduleName, publishInfo) in registryModules)
            {
