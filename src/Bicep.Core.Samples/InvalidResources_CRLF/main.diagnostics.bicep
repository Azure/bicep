...
//@[25:28) Error Parameters default values cannot reference symbols of type 'Resource'. Only other parameters can be referenced in parameter default values. |foo|
