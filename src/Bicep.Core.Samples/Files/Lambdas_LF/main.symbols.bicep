...
//@[004:011) Variable numbers. Type: (>= 0 && <= 4)[]. Declaration start char: 0, length: 25
...
//@[029:030) Local i. Type: >= 0 && <= 4. Declaration start char: 29, length: 1
//@[004:010) Variable isEven. Type: (>= 0 && <= 4)[]. Declaration start char: 0, length: 45

var evenDoggosNestedLambdas = map(filter(numbers, i => contains(filter(numbers, j => 0 == j % 2), i)), x => doggos[x])
//@[080:081) Local j. Type: >= 0 && <= 4. Declaration start char: 80, length: 1
//@[050:051) Local i. Type: >= 0 && <= 4. Declaration start char: 50, length: 1
//@[103:104) Local x. Type: >= 0 && <= 4. Declaration start char: 103, length: 1
...
//@[046:047) Local i. Type: >= 0 && <= 4. Declaration start char: 46, length: 1
...
//@[040:041) Local i. Type: >= 1 && <= 4. Declaration start char: 40, length: 1
//@[004:012) Variable mapArray. Type: int[]. Declaration start char: 0, length: 67
var mapMultiLineArray = flatten(map(range(1, 3), i => [
//@[049:050) Local i. Type: >= 1 && <= 4. Declaration start char: 49, length: 1
...
//@[046:049) Local cur. Type: >= 1 && <= 6. Declaration start char: 46, length: 3
//@[051:055) Local next. Type: >= 1 && <= 6. Declaration start char: 51, length: 4
...
//@[023:027) Local item. Type: >= 0 && <= 10. Declaration start char: 23, length: 4
//@[004:015) Variable itemForLoop. Type: (>= 0 && <= 10)[]. Declaration start char: 0, length: 50
var filteredLoop = filter(itemForLoop, i => i > 5)
//@[039:040) Local i. Type: >= 0 && <= 10. Declaration start char: 39, length: 1
//@[004:016) Variable filteredLoop. Type: (>= 0 && <= 10)[]. Declaration start char: 0, length: 50
...
//@[040:041) Local i. Type: >= 0 && <= 10. Declaration start char: 40, length: 1
//@[053:054) Local i. Type: >= 0 && <= 10. Declaration start char: 53, length: 1
