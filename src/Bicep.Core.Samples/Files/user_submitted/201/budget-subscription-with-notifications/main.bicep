...
@description(
  'The start date of the budget in date format YYYY-MM-DD. Start date should not exceed more than three months in the future'
)
param startDate string

@description(
  'The end date of the budget in date format YYYY-MM-DD. If not provided will default to 10 years from start date'
)
