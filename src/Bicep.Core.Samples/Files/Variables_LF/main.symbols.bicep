...
//@[04:23) Variable incrementingNumbers. Type: (>= 0 && <= 10)[]. Declaration start char: 0, length: 52
var loopInput = [
...
//@[33:34) Local i. Type: >= 0 && <= 10. Declaration start char: 33, length: 1
...
//@[35:36) Local i. Type: >= 0 && <= 3. Declaration start char: 35, length: 1
...
//@[42:43) Local i. Type: >= 0 && <= 3. Declaration start char: 42, length: 1
