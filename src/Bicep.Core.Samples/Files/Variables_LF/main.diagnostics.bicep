...
//@[04:23) [no-unused-vars (Warning)] Variable "curliesWithNoInterp" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |curliesWithNoInterp|
var interp1 = 'abc${123}def'
var interp2 = '${123}def'
var interp3 = 'abc${123}'
//@[04:11) [no-unused-vars (Warning)] Variable "interp3" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |interp3|
var interp4 = 'abc${123}${456}jk$l${789}p$'
//@[04:11) [no-unused-vars (Warning)] Variable "interp4" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |interp4|
var doubleInterp = 'abc${'def${123}'}_${'${456}${789}'}'
//@[04:16) [no-unused-vars (Warning)] Variable "doubleInterp" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |doubleInterp|
var curliesInInterp = '{${123}{0}${true}}'
//@[04:19) [no-unused-vars (Warning)] Variable "curliesInInterp" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |curliesInInterp|

// #completionTest(0) -> declarations

// verify correct bracket escaping
var bracketInTheMiddle = 'a[b]'
//@[04:22) [no-unused-vars (Warning)] Variable "bracketInTheMiddle" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |bracketInTheMiddle|
// #completionTest(25) -> empty
var bracketAtBeginning = '[test'
//@[04:22) [no-unused-vars (Warning)] Variable "bracketAtBeginning" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |bracketAtBeginning|
// #completionTest(23) -> symbolsPlusTypes
var enclosingBrackets = '[test]'
//@[04:21) [no-unused-vars (Warning)] Variable "enclosingBrackets" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |enclosingBrackets|
var emptyJsonArray = '[]'
var interpolatedBrackets = '[${myInt}]'
//@[04:24) [no-unused-vars (Warning)] Variable "interpolatedBrackets" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |interpolatedBrackets|
var nestedBrackets = '[test[]test2]'
//@[04:18) [no-unused-vars (Warning)] Variable "nestedBrackets" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |nestedBrackets|
var nestedInterpolatedBrackets = '[${emptyJsonArray}]'
//@[04:30) [no-unused-vars (Warning)] Variable "nestedInterpolatedBrackets" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |nestedInterpolatedBrackets|
var bracketStringInExpression = concat('[', '\'test\'',']')
//@[04:29) [no-unused-vars (Warning)] Variable "bracketStringInExpression" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |bracketStringInExpression|
...
var myTruth = true
//@[04:11) [no-unused-vars (Warning)] Variable "myTruth" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myTruth|
var myFalsehood = false
//@[04:15) [no-unused-vars (Warning)] Variable "myFalsehood" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myFalsehood|

var myEmptyObj = { }
//@[04:14) [no-unused-vars (Warning)] Variable "myEmptyObj" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myEmptyObj|
var myEmptyArray = [ ]
//@[04:16) [no-unused-vars (Warning)] Variable "myEmptyArray" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myEmptyArray|
...
// array
var myArr = [
//@[04:09) [no-unused-vars (Warning)] Variable "myArr" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myArr|
  'pirates'
  'say'
  'arr'
]
...
//@[04:20) [no-unused-vars (Warning)] Variable "myArrWithObjects" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myArrWithObjects|
  {
    name: 'one'
    enable: true
  }
...
//@[04:18) [no-unused-vars (Warning)] Variable "deploymentName" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |deploymentName|
var templateContentVersion = deployment().properties.template.contentVersion
//@[04:26) [no-unused-vars (Warning)] Variable "templateContentVersion" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |templateContentVersion|
var templateLinkUri = deployment().properties.templateLink.uri
//@[04:19) [no-unused-vars (Warning)] Variable "templateLinkUri" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |templateLinkUri|
var templateLinkId = deployment().properties.templateLink.id
//@[04:18) [no-unused-vars (Warning)] Variable "templateLinkId" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |templateLinkId|

var portalEndpoint = environment().portal
//@[04:18) [no-unused-vars (Warning)] Variable "portalEndpoint" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |portalEndpoint|
var loginEndpoint = environment().authentication.loginEndpoint
//@[04:17) [no-unused-vars (Warning)] Variable "loginEndpoint" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |loginEndpoint|
...
//@[04:22) [no-unused-vars (Warning)] Variable "functionOnIndexer1" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |functionOnIndexer1|
...
//@[04:25) [no-unused-vars (Warning)] Variable "unusedIntermediateRef" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |unusedIntermediateRef|

// previously this was not possible to emit correctly
var previousEmitLimit = [
//@[04:21) [no-unused-vars (Warning)] Variable "previousEmitLimit" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |previousEmitLimit|
  concat('s')
  '${4}'
  {
    a: {
...
//@[04:22) [no-unused-vars (Warning)] Variable "previousEmitLimit2" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |previousEmitLimit2|
  concat('s')
  '${4}'
  {
    a: {
...
//@[04:22) [no-unused-vars (Warning)] Variable "previousEmitLimit3" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |previousEmitLimit3|
  a: {
    b: {
...
var myVar = 'hello'
var myVar2 = any({
//@[04:10) [no-unused-vars (Warning)] Variable "myVar2" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myVar2|
  something: myVar
})
var myVar3 = any(any({
//@[04:10) [no-unused-vars (Warning)] Variable "myVar3" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myVar3|
  something: myVar
}))
var myVar4 = length(any(concat('s','a')))
//@[04:10) [no-unused-vars (Warning)] Variable "myVar4" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myVar4|
...
//@[04:17) [no-unused-vars (Warning)] Variable "I_WANT_IT_ALL" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |I_WANT_IT_ALL|
...
//@[04:07) [no-unused-vars (Warning)] Variable "_1_" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |_1_|
...
//@[04:21) [no-unused-vars (Warning)] Variable "resourceGroupName" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |resourceGroupName|
var resourceGroupObject = az.resourceGroup()
var propertyAccessFromObject = resourceGroupObject.name
//@[04:28) [no-unused-vars (Warning)] Variable "propertyAccessFromObject" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |propertyAccessFromObject|
...
//@[04:34) [no-unused-vars (Warning)] Variable "scopesWithoutArmRepresentation" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |scopesWithoutArmRepresentation|
...
//@[04:12) [no-unused-vars (Warning)] Variable "myBigInt" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myBigInt|
var myIntExpression = 5 * 5
//@[04:19) [no-unused-vars (Warning)] Variable "myIntExpression" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |myIntExpression|
...
//@[04:25) [no-unused-vars (Warning)] Variable "arrayOfStringsViaLoop" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |arrayOfStringsViaLoop|
var arrayOfObjectsViaLoop = [for (name, i) in loopInput: {
//@[04:25) [no-unused-vars (Warning)] Variable "arrayOfObjectsViaLoop" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |arrayOfObjectsViaLoop|
  index: i
  name: name
  value: 'prefix-${i}-${name}-suffix'
}]
var arrayOfArraysViaLoop = [for (name, i) in loopInput: [
//@[04:24) [no-unused-vars (Warning)] Variable "arrayOfArraysViaLoop" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |arrayOfArraysViaLoop|
  i
  name
...
var multilineString = '''
//@[04:19) [no-unused-vars (Warning)] Variable "multilineString" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineString|
HELLO!
'''

var multilineEmpty = ''''''
//@[04:18) [no-unused-vars (Warning)] Variable "multilineEmpty" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineEmpty|
var multilineEmptyNewline = '''
//@[04:25) [no-unused-vars (Warning)] Variable "multilineEmptyNewline" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineEmptyNewline|
'''

// evaluates to '\'abc\''
var multilineExtraQuotes = ''''abc''''
//@[04:24) [no-unused-vars (Warning)] Variable "multilineExtraQuotes" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineExtraQuotes|

// evaluates to '\'\nabc\n\''
var multilineExtraQuotesNewlines = ''''
//@[04:32) [no-unused-vars (Warning)] Variable "multilineExtraQuotesNewlines" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineExtraQuotesNewlines|
abc
''''

var multilineSingleLine = '''hello!'''
//@[04:23) [no-unused-vars (Warning)] Variable "multilineSingleLine" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineSingleLine|

var multilineFormatted = format('''
//@[04:22) [no-unused-vars (Warning)] Variable "multilineFormatted" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineFormatted|
Hello,
my
name is
{0}
...
//@[04:23) [no-unused-vars (Warning)] Variable "multilineJavaScript" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |multilineJavaScript|
...
//@[04:17) [no-unused-vars (Warning)] Variable "pickZonesTest" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |pickZonesTest|
//@[20:29) [BCP241 (Warning)] The "pickZones" function is deprecated and will be removed in a future release of Bicep. Please add a comment to https://github.com/Azure/bicep/issues/2017 if you believe this will impact your workflow. (CodeDescription: none) |pickZones|
