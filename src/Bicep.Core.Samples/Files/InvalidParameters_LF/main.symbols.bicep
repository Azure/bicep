...
//@[06:019) Parameter malformedType. Type: any. Declaration start char: 0, length: 22

// malformed type but type check should still happen
param malformedType2 44 = f
//@[06:020) Parameter malformedType2. Type: any. Declaration start char: 0, length: 27

// malformed type but type check should still happen
@secure('s')
param malformedModifier 44
//@[06:023) Parameter malformedModifier. Type: any. Declaration start char: 0, length: 39
