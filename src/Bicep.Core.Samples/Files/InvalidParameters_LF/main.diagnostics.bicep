...
@allowed([
  resourceGroup().id
//@[02:020) [BCP332 (Warning)] A value of type "string" may be too long to assign to a target of type "string {@minLength(0), @maxLength(5)}". (CodeDescription: none) |resourceGroup().id|
