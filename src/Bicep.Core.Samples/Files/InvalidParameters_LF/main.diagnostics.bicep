...
wrong
//@[00:005) [BCP007 (Error)] This declaration type is not recognized. Specify a parameter, variable, resource, or output declaration. (CodeDescription: none) |wrong|
...
@allowed([
  'abc',
//@[07:008) [BCP106 (Error)] Expected a new line character at this location. Commas are not used as separator delimiters. (CodeDescription: none) |,|
  'def'
])
