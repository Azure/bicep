...
//@[35:41) [BCP070 (Error)] Argument of type "(>= 0 && <= 10) => (>= 0 && <= 10)" is not assignable to parameter of type "any => bool". (CodeDescription: none) |i => i|
...
//@[31:37) [BCP070 (Error)] Argument of type "(>= 0 && <= 10) => (>= 0 && <= 10)" is not assignable to parameter of type "(any, any) => bool". (CodeDescription: none) |i => i|
...
//@[31:42) [BCP070 (Error)] Argument of type "((>= 0 && <= 10), (>= 0 && <= 10)) => (>= 0 && <= 10)" is not assignable to parameter of type "(any, any) => bool". (CodeDescription: none) |(i, j) => i|
...
//@[38:44) [BCP070 (Error)] Argument of type "(>= 0 && <= 10) => (>= 0 && <= 10)" is not assignable to parameter of type "(any, any) => any". (CodeDescription: none) |i => i|
...
//@[39:45) [BCP070 (Error)] Argument of type "(>= 0 && <= 10) => (>= 0 && <= 10)" is not assignable to parameter of type "any => string". (CodeDescription: none) |i => i|
