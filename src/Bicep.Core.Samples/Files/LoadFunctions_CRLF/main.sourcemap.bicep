...
//@[82:82]         "[length(variables('$fxv#10'))]",
    length(loadFileAsBase64('Assets/binary'))
//@[83:83]         "[length(variables('$fxv#11'))]",
    sys.length(loadFileAsBase64('Assets/binary'))
//@[84:84]         "[length(variables('$fxv#12'))]"
  ]
}
