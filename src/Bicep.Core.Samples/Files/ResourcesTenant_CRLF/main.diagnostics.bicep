...
//@[8:39) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. bicep core(https://aka.ms/bicep/linter/prefer-interpolation)|concat(mg.name, '-one-', index)|
  properties: {
...
//@[8:31) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. bicep core(https://aka.ms/bicep/linter/prefer-interpolation)|concat(mg.name, '-two')|
  properties: {
