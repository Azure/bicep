...
//@[8:35) [BCP122 (Error)] Modules: "tenantModuleDuplicateName1", "tenantModuleDuplicateName2", "tenantModuleDuplicateName3" are defined with this same name and this same scope in a file. Rename them or split into different modules. |'tenantModuleDuplicateName'|
  scope: tenant()
}
...
//@[8:44) [BCP122 (Error)] Modules: "managementGroupModuleDuplicateName1", "managementGroupModuleDuplicateName2" are defined with this same name and this same scope in a file. Rename them or split into different modules. |'managementGroupModuleDuplicateName'|
