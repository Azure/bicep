...
//@[79:080) Local i. Type: >= 0 && <= 1. Declaration start char: 79, length: 1
...
//@[72:073) Local i. Type: >= 0 && <= 1. Declaration start char: 72, length: 1
...
//@[04:022) Variable vnetConfigurations. Type: [object, object]. Declaration start char: 0, length: 138
  {
    name: 'one'
    location: resourceGroup().location
  }
...
var moduleSetup = [
//@[04:015) Variable moduleSetup. Type: ['one', 'two', 'three']. Declaration start char: 0, length: 47
  'one'
  'two'
  'three'
]
...
//@[25:030) Local index. Type: >= 0 && <= 2. Declaration start char: 25, length: 5
...
//@[92:097) Local index. Type: >= 0 && <= 2. Declaration start char: 92, length: 5
...
//@[70:071) Local i. Type: >= 0 && <= 10. Declaration start char: 70, length: 1
...
//@[50:051) Local i. Type: >= 0 && <= 6. Declaration start char: 50, length: 1
