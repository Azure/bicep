...
var moduleSetup = [
//@[04:015) Variable moduleSetup. Type: array. Declaration start char: 0, length: 47
  'one'
  'two'
  'three'
]
...
//@[71:081) Local moduleName. Type: any. Declaration start char: 71, length: 10
...
//@[77:087) Local moduleName. Type: any. Declaration start char: 77, length: 10
...
//@[74:084) Local moduleName. Type: any. Declaration start char: 74, length: 10
...
var regions = [
//@[04:011) Variable regions. Type: array. Declaration start char: 0, length: 39
  'eastus'
  'westus'
]

module apim 'passthrough.bicep' = [for region in regions: {
//@[39:045) Local region. Type: any. Declaration start char: 39, length: 6
