...
//@[27:28) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". |=|
...
output foo
//@[7:10) [BCP142 (Error)] Output "foo" is declared multiple times. Remove or rename the duplicates. |foo|
//@[10:10) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". ||

// space after identifier #completionTest(20) -> outputTypes
output spaceAfterId 
//@[20:20) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". ||

// #completionTest(25) -> outputTypes
output spacesAfterCursor  
//@[26:26) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". ||
...
//@[8:8) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". ||

// malformed type
output malformedType 3
//@[21:22) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". |3|
//@[22:22) [BCP018 (Error)] Expected the "=" character at this location. ||

// malformed type but type check should still happen
output malformedType2 3 = 2 + null
//@[22:23) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". |3|
...
//@[27:28) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". |2|

// malformed type before assignment
output lol 2 = true
//@[11:12) [BCP143 (Error)] Expected an output type at this location. Please specify one of the following types: "array", "bool", "int", "object", "string". |2|
...
//@[7:10) [BCP142 (Error)] Output "str" is declared multiple times. Remove or rename the duplicates. |str|
...
output i int = true
//@[7:8) [BCP142 (Error)] Output "i" is declared multiple times. Remove or rename the duplicates. |i|
...
output b bool = [
//@[7:8) [BCP142 (Error)] Output "b" is declared multiple times. Remove or rename the duplicates. |b|
...
output arr array = 32
//@[7:10) [BCP142 (Error)] Output "arr" is declared multiple times. Remove or rename the duplicates. |arr|
...
output o object = 32
//@[7:8) [BCP142 (Error)] Output "o" is declared multiple times. Remove or rename the duplicates. |o|
