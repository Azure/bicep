...
var testSymbol = 42
//@[4:14) [no-unused-vars (Warning)] Variable is declared but never used. |testSymbol|
...
//@[4:30) [no-unused-vars (Warning)] Variable is declared but never used. |attemptToReferenceAnOutput|
