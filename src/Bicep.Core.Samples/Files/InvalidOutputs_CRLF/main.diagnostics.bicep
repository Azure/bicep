...
var testSymbol = 42
//@[4:14) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|testSymbol|
...
//@[4:30) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|attemptToReferenceAnOutput|
