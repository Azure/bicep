...
var foo2 =
//@[04:08) [no-unused-vars (Warning)] Variable "foo2" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-vars) |foo2|
...
var foo3 = asdf
//@[04:08) [no-unused-vars (Warning)] Variable "foo3" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-vars) |foo3|
...
var foo4 = utcNow()
//@[04:08) [no-unused-vars (Warning)] Variable "foo4" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-vars) |foo4|
