...
//@[080:081) Local i. Type: >= 0 && <= 1. Declaration start char: 80, length: 1
...
//@[073:074) Local i. Type: >= 0 && <= 1. Declaration start char: 73, length: 1
...
//@[026:031) Local index. Type: >= 0 && <= 2. Declaration start char: 26, length: 5
...
//@[093:098) Local index. Type: >= 0 && <= 2. Declaration start char: 93, length: 5
