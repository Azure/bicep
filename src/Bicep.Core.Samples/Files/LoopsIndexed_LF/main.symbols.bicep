...
var moduleSetup = [
//@[004:015) Variable moduleSetup. Type: array. Declaration start char: 0, length: 47
  'one'
  'two'
  'three'
]
...
//@[072:082) Local moduleName. Type: any. Declaration start char: 72, length: 10
...
//@[078:088) Local moduleName. Type: any. Declaration start char: 78, length: 10
...
//@[075:085) Local moduleName. Type: any. Declaration start char: 75, length: 10
...
var regions = [
//@[004:011) Variable regions. Type: array. Declaration start char: 0, length: 39
  'eastus'
  'westus'
]

module apim 'passthrough.bicep' = [for (region, i) in regions: {
//@[040:046) Local region. Type: any. Declaration start char: 40, length: 6
