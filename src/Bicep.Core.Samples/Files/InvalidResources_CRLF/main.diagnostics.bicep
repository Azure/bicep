...
//@[8:33) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes1.location|
}

resource runtimeInvalidRes2 'Microsoft.Advisor/recommendations/suppressions@2020-01-01' = {
  name: runtimeValidRes1['location']
//@[8:36) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes1['location']|
}
...
//@[8:50) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes1.properties.evictionPolicy|
  kind:'AzureCLI'
  location: 'eastus'
  properties: {
    azCliVersion: '2.0'
...
resource runtimeInvalidRes4 'Microsoft.Advisor/recommendations/suppressions@2020-01-01' = {
  name: runtimeValidRes1['properties'].evictionPolicy
//@[8:53) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes1['properties'].evictionPolicy|
}

resource runtimeInvalidRes5 'Microsoft.Advisor/recommendations/suppressions@2020-01-01' = {
  name: runtimeValidRes1['properties']['evictionPolicy']
//@[8:56) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes1['properties']['evictionPolicy']|
}
...
//@[8:48) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes2.properties.azCliVersion|
}
...
//@[8:43) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes2['${magicString1}']|
}
...
//@[8:43) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes2['${magicString2}']|
}

resource runtimeInvalidRes10 'Microsoft.Advisor/recommendations/suppressions@2020-01-01' = {
  name: '${runtimeValidRes3.location}'
//@[11:36) [BCP118 (Error)] The property "name" cannot be set using runtime properties. You can only reference the following properties: "type", "apiVersion", "id", "name". |runtimeValidRes3.location|
}
