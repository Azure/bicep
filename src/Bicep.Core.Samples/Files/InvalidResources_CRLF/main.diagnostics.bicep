...
module validModule './module.bicep' = {
  name: 'storageDeploy'
  params: {
//@[2:37) [explicit-values-for-location-params (Warning)] Parameter 'location' of module 'validModule' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    name: 'contoso'\r\n  }|
    name: 'contoso'
  }
}
