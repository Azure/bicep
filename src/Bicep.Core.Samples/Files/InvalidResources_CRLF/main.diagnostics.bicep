...
//@[55:56) [BCP018 (Error)] Expected the "(" character at this location. |{|
  name: 'foo'
//@[8:13) [BCP120 (Error)] Resources: "foo", "foo", "foo", "foo", "foo", "foo", "foo", "foo" are defined with this same name in a file. Rename them or split into different modules. |'foo'|
}
...
resource baz 'Microsoft.Foo/foos@2020-02-02-alpha' = {
  name: 'test'
//@[8:14) [BCP120 (Error)] Resources: "baz", "badDepends", "badDepends2", "badDepends3", "badDepends4", "badDepends5", "badInterp" are defined with this same name in a file. Rename them or split into different modules. |'test'|
  id: 2
...
resource nestedDiscriminatorMissingKey 'Microsoft.DocumentDB/databaseAccounts@2020-06-01-preview' = {
  name: 'test'
//@[8:14) [BCP120 (Error)] Resources: "nestedDiscriminatorMissingKey", "nestedDiscriminator" are defined with this same name in a file. Rename them or split into different modules. |'test'|
  location: 'l'
  properties: {
    //createMode: 'Default'
...
//@[8:30) [BCP120 (Error)] Resources: "invalidDuplicateName1", "invalidDuplicateName2", "invalidDuplicateName3" are defined with this same name in a file. Rename them or split into different modules. |'invalidDuplicateName'|
}
...
//@[8:47) [BCP120 (Error)] Resources: "invalidExtensionResourceDuplicateName1", "invalidExtensionResourceDuplicateName2" are defined with this same name in a file. Rename them or split into different modules. |'invalidExtensionResourceDuplicateName'|
