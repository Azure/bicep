...
//@[089:090) Local i. Type: >= 0 && <= 3. Declaration start char: 89, length: 1
...
//@[018:019) Local j. Type: >= 0 && <= 4. Declaration start char: 18, length: 1
      doesNotExist: 'test'
      name: 'subnet-${i}-${j}'
    }]
  }
...
//@[091:092) Local i. Type: >= 0 && <= 3. Declaration start char: 91, length: 1
...
//@[098:099) Local i. Type: >= 0 && <= 3. Declaration start char: 98, length: 1
...
//@[116:117) Local i. Type: >= 0 && <= 3. Declaration start char: 116, length: 1
...
//@[004:033) Variable issue3000stgManagedByExtended. Type: never[] {@maxLength(0)}. Declaration start char: 0, length: 66
