...
//@[22:38) [BCP036 (Warning)] The property "id" expected a value of type "null | string" but the provided value in source declaration "ipConfigurations" is of type "true". If this is an inaccuracy in the documentation, please report it to the Bicep Team. (CodeDescription: bicep(https://aka.ms/bicep-type-issues)) |ipConfigurations|
