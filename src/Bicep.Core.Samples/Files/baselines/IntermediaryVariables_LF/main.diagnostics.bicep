...
resource nicLoop 'Microsoft.Network/networkInterfaces@2020-11-01' = [for i in range(0, 2): {
  ...
  properties: {
    ipConfigurations: [
      // TODO: fix this
      ipConfigurations[i]
//@[06:25) [BCP036 (Warning)] The property "id" expected a value of type "null | string" but the provided value is of type "true". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP036)) |ipConfigurations[i]|
...
//@[06:25) [BCP036 (Warning)] The property "subnet" expected a value of type "Subnet | null" but the provided value is of type "'hello'". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP036)) |ipConfigurations[i]|
    ]
  }
}]
...
resource nicLoop2 'Microsoft.Network/networkInterfaces@2020-11-01' = [for ipConfig in ipConfigurations: {
  ...
  properties: {
    ipConfigurations: [
      // TODO: fix this
      ipConfig
//@[06:14) [BCP036 (Warning)] The property "id" expected a value of type "null | string" but the provided value in source declaration "ipConfig" is of type "true". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP036)) |ipConfig|
