...
//@[36:57) [no-unused-imports (Warning)] Import "withInvalidIdentifier" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-imports) |withInvalidIdentifier|
