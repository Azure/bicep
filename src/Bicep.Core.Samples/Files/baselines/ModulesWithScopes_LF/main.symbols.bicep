...
//@[7:27) Module myManagementGroupMod. Type: module. Declaration start char: 0, length: 145
...
//@[7:62) Module myManagementGroupModWithDuplicatedNameButDifferentScope. Type: module. Declaration start char: 0, length: 187
  name: 'myManagementGroupMod'
  scope: managementGroup('myManagementGroup2')
}
module mySubscriptionMod 'modules/subscription.bicep' = {
//@[7:24) Module mySubscriptionMod. Type: module. Declaration start char: 0, length: 152
...
//@[7:37) Module mySubscriptionModWithCondition. Type: module. Declaration start char: 0, length: 202
...
//@[7:59) Module mySubscriptionModWithDuplicatedNameButDifferentScope. Type: module. Declaration start char: 0, length: 193
  name: 'mySubscriptionMod'
