...
param intEnum int
//@[06:013) [no-unused-params (Warning)] Parameter "intEnum" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |intEnum|
...
//@[31:244) [BCP418 (Warning)] The assignment target is expecting sensitive data but has been provided a non-sensitive value. Consider supplying the value as a secure parameter instead to prevent unauthorized disclosure to users who can view the template (via the portal, the CLI, or in source code). (bicep https://aka.ms/bicep/core-diagnostics#BCP418) |{\n  enabled: true\n  name: 'this is my object'\n  priority: 3\n  info: {\n    a: 'b'\n  }\n  empty: {\n  }\n  array: [\n    'string item'\n    12\n    true\n    [\n      'inner'\n      false\n    ]\n    {\n      a: 'b'\n    }\n  ]\n}|
  enabled: true
  name: 'this is my object'
  priority: 3
  info: {
...
//@[06:017) [no-unused-params (Warning)] Parameter "nameofParam" is declared but never used. (bicep core linter https://aka.ms/bicep/linter/no-unused-params) |nameofParam|
