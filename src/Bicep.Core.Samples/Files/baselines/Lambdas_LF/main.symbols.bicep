...
//@[029:032) Local dog. Type: any. Declaration start char: 29, length: 3
...
//@[034:035) Local i. Type: any. Declaration start char: 34, length: 1
...
//@[048:052) Local item. Type: any. Declaration start char: 48, length: 4
...
//@[080:081) Local j. Type: any. Declaration start char: 80, length: 1
//@[050:051) Local i. Type: any. Declaration start char: 50, length: 1
//@[103:104) Local x. Type: any. Declaration start char: 103, length: 1
...
//@[042:045) Local foo. Type: any. Declaration start char: 42, length: 3
...
//@[046:047) Local i. Type: any. Declaration start char: 46, length: 1
...
//@[040:041) Local i. Type: any. Declaration start char: 40, length: 1
//@[004:012) Variable mapArray. Type: int[]. Declaration start char: 0, length: 67
var mapMultiLineArray = flatten(map(range(1, 3), i => [
//@[049:050) Local i. Type: any. Declaration start char: 49, length: 1
...
//@[056:059) Local foo. Type: any. Declaration start char: 56, length: 3
...
//@[044:045) Local x. Type: any. Declaration start char: 44, length: 1
//@[047:048) Local y. Type: any. Declaration start char: 47, length: 1
//@[004:015) Variable sortNumeric. Type: (-13 | 10 | 3 | 5 | 8)[]. Declaration start char: 0, length: 59
var sortAlpha = sort(['ghi', 'abc', 'def'], (x, y) => x < y)
//@[045:046) Local x. Type: any. Declaration start char: 45, length: 1
//@[048:049) Local y. Type: any. Declaration start char: 48, length: 1
...
//@[052:053) Local x. Type: any. Declaration start char: 52, length: 1
//@[055:056) Local y. Type: any. Declaration start char: 55, length: 1
...
//@[060:063) Local cur. Type: any. Declaration start char: 60, length: 3
//@[065:069) Local next. Type: any. Declaration start char: 65, length: 4
//@[004:022) Variable reduceStringConcat. Type: any. Declaration start char: 0, length: 92
var reduceStringConcatEven = reduce(['abc', 'def', 'ghi'], '', (cur, next, i) => isEven(i) ? concat(cur, next) : cur)
//@[064:067) Local cur. Type: any. Declaration start char: 64, length: 3
//@[069:073) Local next. Type: any. Declaration start char: 69, length: 4
//@[075:076) Local i. Type: int. Declaration start char: 75, length: 1
//@[004:026) Variable reduceStringConcatEven. Type: any. Declaration start char: 0, length: 117
var reduceFactorial = reduce(range(1, 5), 1, (cur, next) => cur * next)
//@[046:049) Local cur. Type: any. Declaration start char: 46, length: 3
//@[051:055) Local next. Type: any. Declaration start char: 51, length: 4
...
//@[039:040) Local i. Type: any. Declaration start char: 39, length: 1
...
//@[074:078) Local item. Type: any. Declaration start char: 74, length: 4
...
//@[031:034) Local obj. Type: any. Declaration start char: 31, length: 3
  }
}
...
//@[042:043) Local i. Type: any. Declaration start char: 42, length: 1
//@[004:013) Variable objectMap. Type: object. Declaration start char: 0, length: 60
var objectMap2 = toObject(range(0, 10), i => '${i}', i => {
//@[040:041) Local i. Type: any. Declaration start char: 40, length: 1
//@[053:054) Local i. Type: any. Declaration start char: 53, length: 1
...
//@[043:081) Local xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx. Type: any. Declaration start char: 43, length: 38
...
//@[004:013) Variable multiLine. Type: any. Declaration start char: 0, length: 89
  cur,
//@[002:005) Local cur. Type: any. Declaration start char: 2, length: 3
  next
//@[002:006) Local next. Type: any. Declaration start char: 2, length: 4
) => concat(cur, next))

var multiLineWithComment = reduce(['abc', 'def', 'ghi'], '', (
//@[004:024) Variable multiLineWithComment. Type: any. Declaration start char: 0, length: 113
  // comment
  cur,
//@[002:005) Local cur. Type: any. Declaration start char: 2, length: 3
  next
...
//@[003:006) Local val. Type: any. Declaration start char: 3, length: 3
...
//@[003:006) Local arg. Type: any. Declaration start char: 3, length: 3
...
//@[003:006) Local arg. Type: any. Declaration start char: 3, length: 3
//@[020:023) Local arg. Type: any. Declaration start char: 20, length: 3
