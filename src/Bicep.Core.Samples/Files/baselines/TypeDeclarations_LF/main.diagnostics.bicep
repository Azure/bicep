...
//@[06:23) [no-unused-params (Warning)] Parameter "inlineObjectParam" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |inlineObjectParam|
  foo: string
...
//@[06:16) [no-unused-params (Warning)] Parameter "unionParam" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |unionParam|
...
//@[04:14) [no-unused-vars (Warning)] Variable "maybeNull2" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |maybeNull2|
//@[36:44) [prefer-unquoted-property-names (Warning)] Property names that are valid identifiers should be declared without quotation marks and accessed using dot notation. (CodeDescription: Linter(https://aka.ms/bicep/linter/prefer-unquoted-property-names)) |[?'key']|
...
//@[06:39) [no-unused-params (Warning)] Parameter "paramDiscriminatedUnionTypeAlias1" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |paramDiscriminatedUnionTypeAlias1|
param paramDiscriminatedUnionTypeAlias2 discriminatedUnion5
//@[06:39) [no-unused-params (Warning)] Parameter "paramDiscriminatedUnionTypeAlias2" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |paramDiscriminatedUnionTypeAlias2|

@discriminator('type')
param paramInlineDiscriminatedUnion1 typeA | typeB
//@[06:36) [no-unused-params (Warning)] Parameter "paramInlineDiscriminatedUnion1" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |paramInlineDiscriminatedUnion1|

@discriminator('type')
param paramInlineDiscriminatedUnion2 (typeA | typeB) = { type: 'b', value: 0 }
//@[06:36) [no-unused-params (Warning)] Parameter "paramInlineDiscriminatedUnion2" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |paramInlineDiscriminatedUnion2|

@discriminator('type')
param paramInlineDiscriminatedUnion3 (typeA | typeB)?
//@[06:36) [no-unused-params (Warning)] Parameter "paramInlineDiscriminatedUnion3" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |paramInlineDiscriminatedUnion3|
