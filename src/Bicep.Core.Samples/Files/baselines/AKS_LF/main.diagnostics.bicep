...
//@[06:16) [no-unused-params (Warning)] Parameter "agentCount" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-params)) |agentCount|
