...
//@[30:31) Local a. Type: any. Declaration start char: 30, length: 1
...
//@[35:36) Local i. Type: any. Declaration start char: 35, length: 1
//@[04:11) Variable filter5. Type: int[]. Declaration start char: 0, length: 42
var filter6 = filter([true, 'hello!'], i => i)
//@[39:40) Local i. Type: any. Declaration start char: 39, length: 1
//@[04:11) Variable filter6. Type: ('hello!' | true)[]. Declaration start char: 0, length: 46
var filter7 = filter(range(0, 10), (a, b, c) => true)
//@[36:37) Local a. Type: any. Declaration start char: 36, length: 1
...
//@[31:32) Local i. Type: any. Declaration start char: 31, length: 1
...
//@[35:36) Local j. Type: any. Declaration start char: 35, length: 1
//@[04:09) Variable sort6. Type: int[]. Declaration start char: 0, length: 43
...
//@[38:39) Local i. Type: any. Declaration start char: 38, length: 1
...
//@[42:43) Local b. Type: any. Declaration start char: 42, length: 1
...
//@[39:40) Local i. Type: any. Declaration start char: 39, length: 1
//@[04:13) Variable toObject5. Type: object. Declaration start char: 0, length: 46
...
//@[40:41) Local i. Type: any. Declaration start char: 40, length: 1
...
//@[41:42) Local j. Type: any. Declaration start char: 41, length: 1
...
//@[44:45) Local k. Type: any. Declaration start char: 44, length: 1
...
//@[67:68) Local y. Type: any. Declaration start char: 67, length: 1
...
//@[32:33) Local i. Type: any. Declaration start char: 32, length: 1
//@[04:16) Variable modLoopNames. Type: array. Declaration start char: 0, length: 44
output modOutputs array = map(range(0, 5), i => modLoop[i].outputs.foo)
//@[43:44) Local i. Type: any. Declaration start char: 43, length: 1
...
//@[31:32) Local a. Type: any. Declaration start char: 31, length: 1
...
//@[04:27) Variable multiLineTrailingCommas. Type: 'foo'[]. Declaration start char: 0, length: 60
  a,
//@[02:03) Local a. Type: any. Declaration start char: 2, length: 1
  ,) => 'foo')
