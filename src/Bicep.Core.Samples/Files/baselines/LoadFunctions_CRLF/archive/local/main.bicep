{
  ...
  "metadata": {
    "_generator": {
      "name": "bicep",
      "version": "dev",
      "templateHash": "1931506368644184005"
    }
  },
  "variables": {
    ...
    "$fxv#23": [
      {
        "relativePath": "Assets/binary",
        "baseName": "binary",
        "extension": ""
      },
      {
        "relativePath": "Assets/encoding-ascii.txt",
        "baseName": "encoding-ascii.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/encoding-iso.txt",
        "baseName": "encoding-iso.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/encoding-utf16.txt",
        "baseName": "encoding-utf16.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/encoding-utf16be.txt",
        "baseName": "encoding-utf16be.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/encoding-utf8-bom.txt",
        "baseName": "encoding-utf8-bom.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/encoding-utf8.txt",
        "baseName": "encoding-utf8.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/test.json.txt",
        "baseName": "test.json.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/test.yaml.txt",
        "baseName": "test.yaml.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/test2.json.txt",
        "baseName": "test2.json.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/TextFile.CRLF.txt",
        "baseName": "TextFile.CRLF.txt",
        "extension": ".txt"
      },
      {
        "relativePath": "Assets/TextFile.LF.txt",
        "baseName": "TextFile.LF.txt",
        "extension": ".txt"
      }
    ],
    "$fxv#24": [
