...
//@[16:37) [BCP036 (Warning)] The property "accessTier" expected a value of type "'Cool' | 'Hot' | null" but the provided value is of type "'Cold' | 'Hot'". If this is a resource type definition inaccuracy, report it using https://aka.ms/bicep-type-issues. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP036)) |true ? 'Hot' : 'Cold'|
    encryption: {
      keySource: 'Microsoft.Storage'
      services: {
        blob: {
...
//@[04:20) [no-unused-vars (Warning)] Variable "cosmosDbEndpoint" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |cosmosDbEndpoint|
...
//@[04:19) [no-unused-vars (Warning)] Variable "_siteApiVersion" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |_siteApiVersion|
var _siteType = site.type
//@[04:13) [no-unused-vars (Warning)] Variable "_siteType" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |_siteType|
...
//@[16:60) [no-deployments-resources (Warning)] Resource 'nested' of type 'Microsoft.Resources/deployments@2019-10-01' should instead be declared as a Bicep module. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-deployments-resources)) |'Microsoft.Resources/deployments@2019-10-01'|
...
//@[37:68) [BCP081 (Warning)] Resource type "Microsoft.Foo/foos@2019-10-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'Microsoft.Foo/foos@2019-10-01'|
  name: 'nestedTemplate1'
  properties: {
    otherId: nested.id
...
//@[19:43) [BCP081 (Warning)] Resource type "My.Rp/typeA@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/typeA@2020-01-01'|
  name: 'resourceA'
}

resource resourceB 'My.Rp/typeA/typeB@2020-01-01' = {
//@[19:49) [BCP081 (Warning)] Resource type "My.Rp/typeA/typeB@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/typeA/typeB@2020-01-01'|
  name: '${resourceA.name}/myName'
//@[08:34) [use-parent-property (Warning)] Resource "resourceB" has its name formatted as a child of resource "resourceA". The syntax can be simplified by using the parent property. (CodeDescription: Linter(https://aka.ms/bicep/linter/use-parent-property)) |'${resourceA.name}/myName'|
}

resource resourceC 'My.Rp/typeA/typeB@2020-01-01' = {
//@[19:49) [BCP081 (Warning)] Resource type "My.Rp/typeA/typeB@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/typeA/typeB@2020-01-01'|
  name: '${resourceA.name}/myName'
//@[08:34) [use-parent-property (Warning)] Resource "resourceC" has its name formatted as a child of resource "resourceA". The syntax can be simplified by using the parent property. (CodeDescription: Linter(https://aka.ms/bicep/linter/use-parent-property)) |'${resourceA.name}/myName'|
  properties: {
    aId: resourceA.id
...
//@[19:43) [BCP081 (Warning)] Resource type "My.Rp/typeD@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/typeD@2020-01-01'|
  name: 'constant'
  properties: {
    runtime: varBRuntime
...
//@[28:53) [BCP081 (Warning)] Resource type "My.Rp/interp@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/interp@2020-01-01'|
  name: 'interpTest'
  properties: {
    '${myInterpKey}': 1
...
//@[30:61) [BCP081 (Warning)] Resource type "My.Rp/mockResource@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/mockResource@2020-01-01'|
  name: 'test'
  properties: {
...
//@[09:18) [no-unused-existing-resources (Warning)] Existing resource "existing2" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-existing-resources)) |existing2|
//@[19:65) [BCP081 (Warning)] Resource type "Mock.Rp/existingExtensionResource@2020-01-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'Mock.Rp/existingExtensionResource@2020-01-01'|
  name: 'existing2'
  scope: existing1
}
...
//@[04:33) [no-unused-vars (Warning)] Variable "canHaveDuplicatesAcrossScopes" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |canHaveDuplicatesAcrossScopes|
...
//@[04:24) [no-unused-vars (Warning)] Variable "duplicatesEverywhere" is declared but never used. (CodeDescription: Linter(https://aka.ms/bicep/linter/no-unused-vars)) |duplicatesEverywhere|
