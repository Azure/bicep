...
//@[21:50) [BCP081 (Warning)] Resource type "My.Rp/parentType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/parentType@2020-12-01'|
  name: 'basicParent'
  properties: {
    size: 'large'
  }
...
//@[22:33) [BCP081 (Warning)] Resource type "My.Rp/parentType/childType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'childType'|
    name: 'basicChild'
    properties: {
...
//@[24:35) [BCP081 (Warning)] Resource type "My.Rp/parentType/childType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'childType'|
    name: 'basicSibling'
    properties: {
      size: basicParent.properties.size
...
//@[24:53) [BCP081 (Warning)] Resource type "My.Rp/parentType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/parentType@2020-12-01'|
  name: 'existingParent'

  resource existingChild 'childType' existing = {
//@[25:36) [BCP081 (Warning)] Resource type "My.Rp/parentType/childType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'childType'|
    name: 'existingChild'
...
//@[25:54) [BCP081 (Warning)] Resource type "My.Rp/parentType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/parentType@2020-12-01'|
  name: 'conditionParent'

  resource conditionChild 'childType' = if (createChild) {
//@[26:37) [BCP081 (Warning)] Resource type "My.Rp/parentType/childType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'childType'|
    name: 'conditionChild'
...
//@[20:49) [BCP081 (Warning)] Resource type "My.Rp/parentType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'My.Rp/parentType@2020-12-01'|
  name: 'loopParent'

  resource loopChild 'childType' = [for item in items: {
//@[11:20) [BCP179 (Warning)] Unique resource or deployment name is required when looping. The loop item variable "item" must be referenced in at least one of the value expressions of the following properties: "name", "scope" (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP179)) |loopChild|
//@[21:32) [BCP081 (Warning)] Resource type "My.Rp/parentType/childType@2020-12-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (CodeDescription: Core(https://aka.ms/bicep/core-diagnostics#BCP081)) |'childType'|
    name: 'loopChild'
  }]
}
