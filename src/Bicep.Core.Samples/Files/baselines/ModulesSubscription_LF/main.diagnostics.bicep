...
//@[23:45) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. (CodeDescription: Linter(https://aka.ms/bicep/linter/prefer-interpolation)) |concat(name, '-extra')|
}]
