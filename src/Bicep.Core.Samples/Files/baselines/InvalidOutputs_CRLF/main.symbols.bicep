...
//@[07:20) Output malformedType. Type: 3. Declaration start char: 0, length: 22

// malformed type but type check should still happen
output malformedType2 3 = 2 + null
//@[07:21) Output malformedType2. Type: 3. Declaration start char: 0, length: 34

// malformed type assignment
output malformedAssignment 2 = 2
//@[07:26) Output malformedAssignment. Type: 2. Declaration start char: 0, length: 32

// malformed type before assignment
output lol 2 = true
//@[07:10) Output lol. Type: 2. Declaration start char: 0, length: 19
