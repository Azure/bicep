...
//@[000:0049) ├─DeclaredOutputExpression { Name = likewildcard }
//@[020:0024) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[027:0049) | └─FunctionCallExpression { Name = like }
//@[032:0040) |   ├─StringLiteralExpression { Value = abcabc }
//@[042:0048) |   └─StringLiteralExpression { Value = *abc }
output likewildcardtest2 bool = like('aXaYa' , 'a*a')
//@[000:0053) ├─DeclaredOutputExpression { Name = likewildcardtest2 }
//@[025:0029) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[032:0053) | └─FunctionCallExpression { Name = like }
//@[037:0044) |   ├─StringLiteralExpression { Value = aXaYa }
//@[047:0052) |   └─StringLiteralExpression { Value = a*a }
output likewildcardtest3 bool = like('' , '***')
//@[000:0048) ├─DeclaredOutputExpression { Name = likewildcardtest3 }
//@[025:0029) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[032:0048) | └─FunctionCallExpression { Name = like }
//@[037:0039) |   ├─StringLiteralExpression { Value =  }
//@[042:0047) |   └─StringLiteralExpression { Value = *** }
output likewildcardtest4 bool = like('a', 'b')
//@[000:0046) ├─DeclaredOutputExpression { Name = likewildcardtest4 }
//@[025:0029) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[032:0046) | └─FunctionCallExpression { Name = like }
//@[037:0040) |   ├─StringLiteralExpression { Value = a }
//@[042:0045) |   └─StringLiteralExpression { Value = b }
output likewildcardtest5 bool = like('abc**def', '*def')
//@[000:0056) ├─DeclaredOutputExpression { Name = likewildcardtest5 }
//@[025:0029) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[032:0056) | └─FunctionCallExpression { Name = like }
//@[037:0047) |   ├─StringLiteralExpression { Value = abc**def }
//@[049:0055) |   └─StringLiteralExpression { Value = *def }
output likewildcardtest6 bool = like('aXbYa', 'a*b*a')
//@[000:0054) ├─DeclaredOutputExpression { Name = likewildcardtest6 }
//@[025:0029) | ├─AmbientTypeReferenceExpression { Name = bool }
//@[032:0054) | └─FunctionCallExpression { Name = like }
//@[037:0044) |   ├─StringLiteralExpression { Value = aXbYa }
//@[046:0053) |   └─StringLiteralExpression { Value = a*b*a }
