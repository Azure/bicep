...
//@[04:10) Variable myVar4. Type: any. Declaration start char: 0, length: 41
...
var name = 'Anthony'
//@[04:08) Variable name. Type: 'Anthony'. Declaration start char: 0, length: 20
var multilineInterpolation = $'''
//@[04:26) Variable multilineInterpolation. Type: 'Hello,\nmy\nname is\nAnthony\n'. Declaration start char: 0, length: 63
Hello,
my
name is
${name}
...
//@[04:33) Variable complexMultilineInterpolation. Type: '\${name}\n$\${name}\nAnthony\n$Anthony\n'. Declaration start char: 0, length: 84
${name}
$${name}
$$${name}
$$$${name}
...
//@[04:20) Variable interpMultiEmpty. Type: ''. Declaration start char: 0, length: 30
var interp1Multi = $'''
//@[04:16) Variable interp1Multi. Type: 'abc123def\n'. Declaration start char: 0, length: 40
abc${123}def
'''
var interp2Multi = $'''${123}def'''
//@[04:16) Variable interp2Multi. Type: '123def'. Declaration start char: 0, length: 35
var interp3Multi = $$'''abc$${123}'''
//@[04:16) Variable interp3Multi. Type: 'abc123'. Declaration start char: 0, length: 37
var interp4Multi = $'''abc${123}${456}jk$l${789}p$'''
//@[04:16) Variable interp4Multi. Type: 'abc123456jk$l789p$'. Declaration start char: 0, length: 53
var doubleInterpMulti = $'''abc${'def${123}'}_${'${456}${789}'}'''
//@[04:21) Variable doubleInterpMulti. Type: 'abcdef123_456789'. Declaration start char: 0, length: 66
var curliesInInterpMulti = $'''{${123}{0}${true}}'''
//@[04:24) Variable curliesInInterpMulti. Type: '{123{0}True}'. Declaration start char: 0, length: 52
