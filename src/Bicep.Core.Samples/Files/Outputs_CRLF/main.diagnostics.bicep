...
//@[27:86) [outputs-should-not-contain-secrets (Warning)] Don't include secrets in an output. Found: function 'listKeys' (CodeDescription: bicep core(https://aka.ms/bicep/linter/outputs-should-not-contain-secrets)) |listKeys(resourceId('Mock.RP/type', 'nigel'), '2020-01-01')|
