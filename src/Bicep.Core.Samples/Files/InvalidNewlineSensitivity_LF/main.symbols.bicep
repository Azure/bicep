...
//@[4:27) Variable singleLineArrayNoCommas. Type: string[]. Declaration start char: 0, length: 43

var multiLineArrayMultipleCommas = [
//@[4:32) Variable multiLineArrayMultipleCommas. Type: string[]. Declaration start char: 0, length: 59
  'abc',,
  'def',,,
]
