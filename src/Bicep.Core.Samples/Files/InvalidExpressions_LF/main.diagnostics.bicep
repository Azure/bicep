...
@minLength()
//@[00:12) [BCP132 (Error)] Expected a declaration after the decorator. (CodeDescription: none) |@minLength()|
//@[01:10) [BCP126 (Error)] Function "minLength" cannot be used as a variable decorator. (CodeDescription: none) |minLength|
