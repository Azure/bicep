...
//@[21:22) Local i. Type: >= 0 && <= 3. Declaration start char: 21, length: 1
    objParam: module
    stringParamB: module.location
  }
}]
...
//@[14:15) Local i. Type: >= 0 && <= 10. Declaration start char: 14, length: 1
      b: [for i in range(1,2): i]
//@[14:15) Local i. Type: >= 1 && <= 3. Declaration start char: 14, length: 1
      c: {
        d: [for j in range(2,3): j]
//@[16:17) Local j. Type: >= 2 && <= 5. Declaration start char: 16, length: 1
      }
      e: [for k in range(4,4): {
//@[14:15) Local k. Type: >= 4 && <= 8. Declaration start char: 14, length: 1
        f: k
      }]
    }
    stringParamB: ''
...
//@[16:17) Local j. Type: >= 7 && <= 14. Declaration start char: 16, length: 1
      }
    ]
  }
}
...
//@[15:16) Local i. Type: >= 0 && <= 10. Declaration start char: 15, length: 1
//@[18:20) Local i2. Type: int. Declaration start char: 18, length: 2
      b: [for (i, i2) in range(1,2): i / i2]
//@[15:16) Local i. Type: >= 1 && <= 3. Declaration start char: 15, length: 1
//@[18:20) Local i2. Type: int. Declaration start char: 18, length: 2
      c: {
        d: [for (j, j2) in range(2,3): j * j2]
//@[17:18) Local j. Type: >= 2 && <= 5. Declaration start char: 17, length: 1
//@[20:22) Local j2. Type: int. Declaration start char: 20, length: 2
      }
      e: [for (k, k2) in range(4,4): {
//@[15:16) Local k. Type: >= 4 && <= 8. Declaration start char: 15, length: 1
...
//@[79:84) Local thing. Type: >= 0 && <= 1. Declaration start char: 79, length: 5
