...
//@[127:1943]             "stringParamB": {
param deployTimeSuffix string = newGuid()
//@[11:1660]     "deployTimeSuffix": {

@sys.description('this module a')
//@[212:262]               "location": "[parameters('location')]"
module modATest './modulea.bicep' = {
//@[85:1873]       "type": "Microsoft.Resources/deployments",
  name: 'modATest'
//@[88:750]       "name": "modATest",
  params: {
//@[142:1670]               "location": "[parameters('stringParamA')]"
    stringParamB: 'hello!'
//@[397:752]                 3
    objParam: {
      a: 'b'
//@[100:1677]               "a": "b"
    ...
    arrayParam: [
//@[148:1676]               "location": "[parameters('stringParamB')]"
      {
        a: 'b'
//@[106:763]                 "a": "b"
      }
