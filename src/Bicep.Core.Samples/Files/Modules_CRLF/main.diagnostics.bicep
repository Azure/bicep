...
//@[20:97) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat(resWithDependencies.id, optionalWithAllParamsAndManualDependency.name)|
    optionalInt: 42
    optionalObj: { }
    optionalArray: [ ]
  }
...
//@[18:32) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat('a', i)|
  }
}]
...
//@[38:74) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat('test-', i, '-', module.name)|
    objParam: module
    stringParamB: module.location
  }
}]
...
//@[4:25) [no-unused-vars (Warning)] Variable is declared but never used. |duplicateAcrossScopes|
...
//@[4:17) [no-unused-vars (Warning)] Variable is declared but never used. |someDuplicate|
var otherDuplicate = false
//@[4:18) [no-unused-vars (Warning)] Variable is declared but never used. |otherDuplicate|
