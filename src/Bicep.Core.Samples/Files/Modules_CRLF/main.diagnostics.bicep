...
module modATest './modulea.bicep' = {
  name: 'modATest'
  params: {
//@[2:155) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'modATest' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    stringParamB: 'hello!'\r\n    objParam: {\r\n      a: 'b'\r\n    }\r\n    arrayParam: [\r\n      {\r\n        a: 'b'\r\n      }\r\n      'abc'\r\n    ]\r\n  }|
    stringParamB: 'hello!'
    objParam: {
      a: 'b'
    }
...
module storageResources 'modulea.bicep' = [for module in myModules: {
  name: module.name
  params: {
//@[2:93) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'storageResources' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    arrayParam: []\r\n    objParam: module\r\n    stringParamB: module.location\r\n  }|
    arrayParam: []
    objParam: module
    stringParamB: module.location
  }
...
module nestedModuleLoop 'modulea.bicep' = [for module in myModules: {
  name: module.name
  params: {
//@[2:150) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'nestedModuleLoop' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    arrayParam: [for i in range(0,3): concat('test-', i, '-', module.name)]\r\n    objParam: module\r\n    stringParamB: module.location\r\n  }|
    arrayParam: [for i in range(0,3): concat('test-', i, '-', module.name)]
...
module duplicatesEverywhere 'modulea.bicep' = [for someDuplicate in []: {
  ...
  params: {
//@[2:150) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'duplicatesEverywhere' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    objParam: {}\r\n    stringParamB: 'test'\r\n    arrayParam: [for otherDuplicate in emptyArray: '${someDuplicate}-${otherDuplicate}']\r\n  }|
    objParam: {}
    stringParamB: 'test'
    arrayParam: [for otherDuplicate in emptyArray: '${someDuplicate}-${otherDuplicate}']
  }
...
module propertyLoopInsideParameterValueWithIndexes 'modulea.bicep' = {
  ...
  params: {
//@[2:384) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'propertyLoopInsideParameterValueWithIndexes' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    objParam: {\r\n      a: [for (i, i2) in range(0,10): i + i2]\r\n      b: [for (i, i2) in range(1,2): i / i2]\r\n      c: {\r\n        d: [for (j, j2) in range(2,3): j * j2]\r\n      }\r\n      e: [for (k, k2) in range(4,4): {\r\n        f: k\r\n        g: k2\r\n      }]\r\n    }\r\n    stringParamB: ''\r\n    arrayParam: [\r\n      {\r\n        e: [for j in range(7,7): j]\r\n      }\r\n    ]\r\n  }|
    objParam: {
      a: [for (i, i2) in range(0,10): i + i2]
      b: [for (i, i2) in range(1,2): i / i2]
      c: {
...
//@[7:55) [BCP179 (Warning)] The loop item variable "thing" must be referenced in at least one of the value expressions of the following properties: "name", "scope" (CodeDescription: none) |propertyLoopInsideParameterValueInsideModuleLoop|
  ...
  params: {
//@[2:362) [explicit-values-for-location-params (Warning)] Parameter 'stringParamA' of module 'propertyLoopInsideParameterValueInsideModuleLoop' isn't assigned an explicit value, and its default value may not give the intended behavior for a location-related parameter. You should assign an explicit value to the parameter. (CodeDescription: bicep core(https://aka.ms/bicep/linter/explicit-values-for-location-params)) |params: {\r\n    objParam: {\r\n      a: [for i in range(0,10): i + thing]\r\n      b: [for i in range(1,2): i * thing]\r\n      c: {\r\n        d: [for j in range(2,3): j]\r\n      }\r\n      e: [for k in range(4,4): {\r\n        f: k - thing\r\n      }]\r\n    }\r\n    stringParamB: ''\r\n    arrayParam: [\r\n      {\r\n        e: [for j in range(7,7): j % thing]\r\n      }\r\n    ]\r\n  }|
    objParam: {
      a: [for i in range(0,10): i + thing]
      b: [for i in range(1,2): i * thing]
      c: {
