...
//@[4:7) [no-unused-vars (Warning)] Variable is declared but never used. |foo|
//@[7:7) [BCP018 (Error)] Expected the "=" character at this location. ||

// #completionTest(18,19) -> symbols
var missingValue = 
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |missingValue|
...
//@[4:5) [no-unused-vars (Warning)] Variable is declared but never used. |2|
...
//@[4:5) [BCP015 (Error)] Expected a variable identifier at this location. |#|
//@[4:5) [BCP001 (Error)] The following token is not recognized: "#". |#|
//@[4:8) [no-unused-vars (Warning)] Variable is declared but never used. |# 33|
...
// bad =
var badEquals 2
//@[4:13) [no-unused-vars (Warning)] Variable is declared but never used. |badEquals|
...
//@[4:14) [no-unused-vars (Warning)] Variable is declared but never used. |badEquals2|
...
//@[4:7) [no-unused-vars (Warning)] Variable is declared but never used. |bar|
...
//@[4:5) [no-unused-vars (Warning)] Variable is declared but never used. |y|
...
var x = [
//@[4:5) [BCP028 (Error)] Identifier "x" is declared multiple times. Remove or rename the duplicates. |x|
//@[4:5) [no-unused-vars (Warning)] Variable is declared but never used. |x|
  3 + 4
  =
...
var testDupe = {
//@[4:12) [no-unused-vars (Warning)] Variable is declared but never used. |testDupe|
  'duplicate': true
...
//@[4:9) [no-unused-vars (Warning)] Variable is declared but never used. |mySum|
//@[15:18) [BCP107 (Error)] The function "add" does not exist in namespace "az". |add|
var myConcat = sys.concat('a', az.concat('b', 'c'))
//@[4:12) [no-unused-vars (Warning)] Variable is declared but never used. |myConcat|
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |doubleString|
...
//@[4:10) [no-unused-vars (Warning)] Variable is declared but never used. |rgName|
...
//@[4:22) [no-unused-vars (Warning)] Variable is declared but never used. |invalidLocationVar|
...
//@[4:25) [no-unused-vars (Warning)] Variable is declared but never used. |invalidEnvironmentVar|
...
//@[4:21) [no-unused-vars (Warning)] Variable is declared but never used. |invalidEnvAuthVar|
...
//@[4:6) [no-unused-vars (Warning)] Variable is declared but never used. |az|

// cannot assign a variable to a namespace
var invalidNamespaceAssignment = az
//@[4:30) [no-unused-vars (Warning)] Variable is declared but never used. |invalidNamespaceAssignment|
...
//@[4:32) [no-unused-vars (Warning)] Variable is declared but never used. |objectVarTopLevelCompletions|
...
//@[4:33) [no-unused-vars (Warning)] Variable is declared but never used. |objectVarTopLevelCompletions2|
...
//@[4:29) [no-unused-vars (Warning)] Variable is declared but never used. |mixedArrayTypeCompletions|
// #completionTest(60) -> mixedArrayProperties
var mixedArrayTypeCompletions2 = objectLiteralType.fifth[0].
//@[4:30) [no-unused-vars (Warning)] Variable is declared but never used. |mixedArrayTypeCompletions2|
...
//@[4:27) [no-unused-vars (Warning)] Variable is declared but never used. |oneArrayItemCompletions|
...
//@[4:28) [no-unused-vars (Warning)] Variable is declared but never used. |oneArrayItemCompletions2|
...
//@[4:42) [no-unused-vars (Warning)] Variable is declared but never used. |objectVarTopLevelArrayIndexCompletions|
...
//@[4:28) [no-unused-vars (Warning)] Variable is declared but never used. |oneArrayIndexCompletions|
//@[58:58) [BCP117 (Error)] An empty indexer is not allowed. Specify a valid expression. ||

// Issue 486
var myFloat = 3.14
//@[4:11) [no-unused-vars (Warning)] Variable is declared but never used. |myFloat|
...
var something = 1
//@[4:13) [no-unused-vars (Warning)] Variable is declared but never used. |something|
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |anotherThing|
...
//@[4:5) [no-unused-vars (Warning)] Variable is declared but never used. |☕|
var a☕ = true
//@[4:5) [no-unused-vars (Warning)] Variable is declared but never used. |a|
...
//@[4:24) [no-unused-vars (Warning)] Variable is declared but never used. |missingArrayVariable|
//@[41:46) [BCP057 (Error)] The name "stuff" does not exist in the current context. |stuff|

// loops are only allowed at the top level
var nonTopLevelLoop = {
//@[4:19) [no-unused-vars (Warning)] Variable is declared but never used. |nonTopLevelLoop|
...
//@[4:30) [no-unused-vars (Warning)] Variable is declared but never used. |noFilteredLoopsInVariables|
...
//@[4:31) [no-unused-vars (Warning)] Variable is declared but never used. |noNestedVariableLoopsEither|
...
//@[4:21) [no-unused-vars (Warning)] Variable is declared but never used. |innerPropertyLoop|
...
//@[4:22) [no-unused-vars (Warning)] Variable is declared but never used. |innerPropertyLoop2|
  b: {
    a: [for i in range(0,10): i]
...
//@[4:15) [no-unused-vars (Warning)] Variable is declared but never used. |runtimeLoop|
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |runtimeLoop2|
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |runtimeLoop3|
  a: inlinedVariable
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |runtimeLoop4|
...
//@[17:32) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat('a','b')|
var evenMoreIndirection = concat(notRuntime, string(moreIndirection))
//@[26:69) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat(notRuntime, string(moreIndirection))|
...
//@[4:16) [no-unused-vars (Warning)] Variable is declared but never used. |runtimeLoop5|
...
//@[4:18) [no-unused-vars (Warning)] Variable is declared but never used. |loopExpression|
...
//@[4:29) [no-unused-vars (Warning)] Variable is declared but never used. |batchSizeMakesNoSenseHere|
...
//@[4:21) [no-unused-vars (Warning)] Variable is declared but never used. |keyVaultSecretVar|
...
//@[4:33) [no-unused-vars (Warning)] Variable is declared but never used. |keyVaultSecretInterpolatedVar|
...
//@[4:27) [no-unused-vars (Warning)] Variable is declared but never used. |keyVaultSecretObjectVar|
...
//@[4:26) [no-unused-vars (Warning)] Variable is declared but never used. |keyVaultSecretArrayVar|
...
//@[4:38) [no-unused-vars (Warning)] Variable is declared but never used. |keyVaultSecretArrayInterpolatedVar|
  '${kv.getSecret('mySecret')}'
