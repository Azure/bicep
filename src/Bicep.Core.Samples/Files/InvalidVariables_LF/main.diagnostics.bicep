...
//@[04:12) [no-unused-vars (Warning)] Variable "testDupe" is declared but never used. (CodeDescription: bicep core(https://aka.ms/bicep/linter/no-unused-vars)) |testDupe|
  'duplicate': true
//@[02:13) [prefer-property-names-no-quotation (Warning)] Properties that are valid identifiers should be declared without quotations and accessed using dot notation. (CodeDescription: bicep core(https://aka.ms/bicep/linter/prefer-property-names-no-quotation)) |'duplicate'|
