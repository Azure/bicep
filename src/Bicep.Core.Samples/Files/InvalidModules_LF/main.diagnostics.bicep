...
//@[4:35) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|modulePropertyAccessCompletions|
...
//@[4:48) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|moduleWithConditionPropertyAccessCompletions|
...
//@[4:28) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|moduleOutputsCompletions|
...
//@[4:41) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|moduleWithConditionOutputsCompletions|
...
//@[4:21) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|unspecifiedOutput|
...
//@[8:89) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. bicep core(https://aka.ms/bicep/linter/prefer-interpolation)|concat(concat(runtimeValidRes1.id, runtimeValidRes1.name), runtimeValidRes1.type)|
}
...
//@[8:119) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. bicep core(https://aka.ms/bicep/linter/prefer-interpolation)|concat(moduleLoopForRuntimeCheck[1].outputs.stringOutputB, moduleLoopForRuntimeCheck[1].outputs.stringOutputA )|
...
//@[4:50) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|propertyAccessCompletionsForFilteredModuleLoop|
//@[100:100) [BCP020 (Error)] Expected a function or property name at this location. ||

// nonexistent arrays and loop variables
var evenMoreDuplicates = 'there'
//@[4:22) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|evenMoreDuplicates|
...
//@[16:69) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. bicep core(https://aka.ms/bicep/linter/prefer-interpolation)|concat(wrongModuleParameterInLoop, nonexistentArrays)|
