...
//@[4:35) [no-unused-vars (Warning)] Variable is declared but never used. |modulePropertyAccessCompletions|
...
//@[4:48) [no-unused-vars (Warning)] Variable is declared but never used. |moduleWithConditionPropertyAccessCompletions|
...
//@[4:28) [no-unused-vars (Warning)] Variable is declared but never used. |moduleOutputsCompletions|
...
//@[4:41) [no-unused-vars (Warning)] Variable is declared but never used. |moduleWithConditionOutputsCompletions|
...
//@[4:21) [no-unused-vars (Warning)] Variable is declared but never used. |unspecifiedOutput|
...
//@[8:89) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat(concat(runtimeValidRes1.id, runtimeValidRes1.name), runtimeValidRes1.type)|
}
...
//@[8:119) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat(moduleLoopForRuntimeCheck[1].outputs.stringOutputB, moduleLoopForRuntimeCheck[1].outputs.stringOutputA )|
...
//@[4:50) [no-unused-vars (Warning)] Variable is declared but never used. |propertyAccessCompletionsForFilteredModuleLoop|
//@[100:100) [BCP020 (Error)] Expected a function or property name at this location. ||

// nonexistent arrays and loop variables
var evenMoreDuplicates = 'there'
//@[4:22) [no-unused-vars (Warning)] Variable is declared but never used. |evenMoreDuplicates|
...
//@[16:69) [prefer-interpolation (Warning)] Use string interpolation instead of the concat function. |concat(wrongModuleParameterInLoop, nonexistentArrays)|
