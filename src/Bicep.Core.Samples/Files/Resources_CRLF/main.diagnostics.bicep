...
//@[4:20) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|cosmosDbEndpoint|
...
//@[4:19) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|_siteApiVersion|
var _siteType = site.type
//@[4:13) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|_siteType|
...
//@[4:33) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|canHaveDuplicatesAcrossScopes|
...
//@[4:24) [no-unused-vars (Warning)] Variable is declared but never used. bicep core(https://aka.ms/bicep/linter/no-unused-vars)|duplicatesEverywhere|
