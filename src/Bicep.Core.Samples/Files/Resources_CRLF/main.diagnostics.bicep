...
//@[4:20) [no-unused-vars (Warning)] Variable is declared but never used. |cosmosDbEndpoint|
...
//@[4:19) [no-unused-vars (Warning)] Variable is declared but never used. |_siteApiVersion|
var _siteType = site.type
//@[4:13) [no-unused-vars (Warning)] Variable is declared but never used. |_siteType|
...
//@[4:33) [no-unused-vars (Warning)] Variable is declared but never used. |canHaveDuplicatesAcrossScopes|
...
//@[4:24) [no-unused-vars (Warning)] Variable is declared but never used. |duplicatesEverywhere|
