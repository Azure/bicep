...
//@[9:21) Resource basicStorage. Type: Microsoft.Storage/storageAccounts@2019-06-01. Declaration start char: 0, length: 221
  name: 'basicblobs'
  location: 'westus'
  kind: 'BlobStorage'
  sku: {
...
//@[9:16) Resource dnsZone. Type: Microsoft.Network/dnsZones@2018-05-01. Declaration start char: 0, length: 136
  name: 'myZone'
  location: 'global'
}
...
//@[9:24) Resource vmWithCondition. Type: Microsoft.Compute/virtualMachines@2020-06-01. Declaration start char: 0, length: 304
  name: 'vmName'
  location: 'westus'
  properties: {
    osProfile: {
...
//@[9:18) Resource existing1. Type: Mock.Rp/existingExtensionResource@2020-01-01. Declaration start char: 0, length: 158
  name: 'existing1'
  scope: extension1
}
...
//@[9:25) Resource storageResources. Type: Microsoft.Storage/storageAccounts@2019-06-01[]. Declaration start char: 0, length: 280
  name: account.name
...
//@[9:34) Resource storageResourcesWithIndex. Type: Microsoft.Storage/storageAccounts@2019-06-01[]. Declaration start char: 0, length: 314
  name: '${account.name}${i}'
  location: account.location
  sku: {
    name: 'Standard_LRS'
...
//@[9:13) Resource vnet. Type: Microsoft.Network/virtualNetworks@2020-06-01[]. Declaration start char: 0, length: 394
  name: 'vnet-${i}'
  properties: {
