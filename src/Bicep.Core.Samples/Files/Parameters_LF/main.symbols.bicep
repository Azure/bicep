...
//@[6:15) Parameter someArray. Type: array {@minLength(3), @maxLength(24)}. Declaration start char: 0, length: 50
...
//@[6:18) Parameter decoratedInt. Type: >= 100. Declaration start char: 0, length: 43

// negative integer literals are allowed as decorator values
@minValue(-10)
@maxValue(-3)
param negativeValues int
//@[6:20) Parameter negativeValues. Type: >= -10 && <= -3. Declaration start char: 0, length: 53
...
//@[6:20) Parameter decoratedArray. Type: array {@maxLength(20)}. Declaration start char: 0, length: 166
    utcNow()
    newGuid()
]
