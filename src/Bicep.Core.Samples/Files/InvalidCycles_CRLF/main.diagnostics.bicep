...
//self-cycle
var x = x
//@[08:09) [BCP079 (Error)] This expression is referencing its own declaration, which is not allowed. (CodeDescription: none) |x|
var q = base64(q, !q)
...
//2-cycle
var a = b
//@[08:09) [BCP080 (Error)] The expression is involved in a cycle ("b" -> "a"). (CodeDescription: none) |b|
var b = max(a,1)
//@[12:13) [BCP080 (Error)] The expression is involved in a cycle ("a" -> "b"). (CodeDescription: none) |a|

//3-cycle
var e = f
//@[08:09) [BCP080 (Error)] The expression is involved in a cycle ("f" -> "g" -> "e"). (CodeDescription: none) |f|
var f = g && true
//@[08:09) [BCP080 (Error)] The expression is involved in a cycle ("g" -> "e" -> "f"). (CodeDescription: none) |g|
var g = e ? e : e
//@[08:09) [BCP080 (Error)] The expression is involved in a cycle ("e" -> "f" -> "g"). (CodeDescription: none) |e|
...
var aa = {
  bb: bb
//@[06:08) [BCP080 (Error)] The expression is involved in a cycle ("bb" -> "cc" -> "dd" -> "aa"). (CodeDescription: none) |bb|
}
var bb = {
  cc: cc
//@[06:08) [BCP080 (Error)] The expression is involved in a cycle ("cc" -> "dd" -> "aa" -> "bb"). (CodeDescription: none) |cc|
}
var cc = {
  dd: dd
//@[06:08) [BCP080 (Error)] The expression is involved in a cycle ("dd" -> "aa" -> "bb" -> "cc"). (CodeDescription: none) |dd|
}
var dd = {
  aa: aa
//@[06:08) [BCP080 (Error)] The expression is involved in a cycle ("aa" -> "bb" -> "cc" -> "dd"). (CodeDescription: none) |aa|
}

// variable completion cycles
var one = {
  first: two
//@[09:12) [BCP080 (Error)] The expression is involved in a cycle ("two" -> "one"). (CodeDescription: none) |two|
}
