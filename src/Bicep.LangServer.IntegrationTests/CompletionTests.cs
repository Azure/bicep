...
",
        ...
        public async Task ModuleRegistryReferenceCompletions_GetPathCompletions_PublicRegistries(string inputWithCursors, BicepSourceFileKind kind)
        {
            ...
            publicRegistryModuleMetadataProvider.Setup(x => x.GetModulesMetadata()).Returns([PublicModuleMetadata("app/dapr-containerapp", "d1", "contoso.com/help1"), PublicModuleMetadata("app/dapr-containerapp-env", "d2", "contoso.com/help2")]);
        ...
        public async Task ModuleRegistryReferenceCompletions_GetVersionCompletions(string inputWithCursors, BicepSourceFileKind kind)//asdfg existing test
        {
            ...
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetModulesMetadata()).Returns([PublicModuleMetadata("app/dapr-containerapp", "d1", "contoso.com/help1")]);
        ...
        public async Task Public_registry_completions_support_prefix_matching(string text, BicepSourceFileKind kind)
        {
            ...
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetModulesMetadata()).Returns([PublicModuleMetadata("foo/bar", "d1", "contoso.com/help1"), PublicModuleMetadata("food/bar", "d2", "contoso.com/help2"), PublicModuleMetadata("bar/bar", "d2", "contoso.com/help2")]);
