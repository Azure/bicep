resource windowsVMDiagnostics 'Microsoft.Compute/virtualMachines/extensions@2020-12-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      ...
      storageAccountKey: listkeys(resourceId('Microsoft.Storage/storageAccounts', 'storageaccount'), '2015-06-15').key1
      storageAccountEndPoint: reference(resourceId('Microsoft.Storage/storageAccounts', 'storageaccount'), '2015-06-15').primaryEndpoints.blob
    }
  }
}
