...
//@[31:73) [BCP081 (Warning)] Resource type "Microsoft.Insights/alertrules@2016-03-01" does not have types available. Bicep is unable to validate resource properties prior to deployment, but this will not block the resource from being deployed. (bicep https://aka.ms/bicep/core-diagnostics#BCP081) |'Microsoft.Insights/alertrules@2016-03-01'|
  name: 'name'
  location: location
  properties: {
    name: 'name'
