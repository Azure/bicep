...
// Workaround for "error TS4023: Exported variable 'Provider' has or is using name 'PrdStore' from external module "F:/bicep/src/vscode-bicep-ui/node_modules/jotai/esm/vanilla/store" but cannot be named".
