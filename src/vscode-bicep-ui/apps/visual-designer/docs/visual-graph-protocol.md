...
This document describes the server-driven visual graph protocol used by the Bicep visual designer. It
covers the graph and layout contract only; features layered on it, such as
[resource creation](resource-creation-design.md), document their own messages and any rule they add.
