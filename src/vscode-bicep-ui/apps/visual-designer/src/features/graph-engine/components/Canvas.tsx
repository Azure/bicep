...
function buildGrabCursor(fill: string, opacity: number): string {
  return (
    `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" fill="${fill}" fill-opacity="${opacity}" width="32px" height="32px" viewBox="0 0 10 10"><circle cx="5" cy="5" r="4"/></svg>') 16 16, auto`
  );
}
