...
import type {
  ...
  ResourceTypeCatalogGroup,
  ResourceTypeNamespace,
} from "./ResourcePalette.types";
...
import { getErrorMessage } from "./resource-palette-utils";
...
function ResourceTypeItems({
  ...
  onResourceTypeActivate?: ResourcePaletteProps["onResourceTypeActivate"];
  onResourceTypePointerDown?: ResourcePaletteProps["onResourceTypePointerDown"];
}) {
  return (
    <$Items>
...
function LazyResourceTypeGroup({
  ...
  loadNamespace: ResourcePaletteProps["loadNamespace"];
  onResourceTypeActivate?: ResourcePaletteProps["onResourceTypeActivate"];
  onResourceTypePointerDown?: ResourcePaletteProps["onResourceTypePointerDown"];
}) {
  ...
  return (
    <$Groups>
      <Accordion
        ...
        onValueChange={(value) => setExpandedGroups(value.map(String))}
      >
