...
import type { ResourcePaletteProps, ResourceTypeCatalogGroup } from "./ResourcePalette.types";
...
export function useResourceTypeSearch(search: ResourcePaletteProps["search"]) {
