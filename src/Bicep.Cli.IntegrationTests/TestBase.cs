...
namespace Bicep.Cli.IntegrationTests
{
    ...
    {
        private static BicepCompiler CreateCompiler(IContainerRegistryClientFactory clientFactory, ITemplateSpecRepositoryFactory templateSpecRepositoryFactory, PublicRegistryModuleIndexHttpClient? moduleMetadataClient)
        ...
        protected record InvocationSettings
        {
            ...
            public PublicRegistryModuleIndexHttpClient ModuleMetadataClient { get; init; }
            ...
            public InvocationSettings(
                ...
                PublicRegistryModuleIndexHttpClient? ModuleMetadataClient = null)
            {
                ...
                this.ModuleMetadataClient = ModuleMetadataClient ?? StrictMock.Of<PublicRegistryModuleIndexHttpClient>().Object;
            }
        }
        ...
        protected static async Task<IEnumerable<string>> GetAllDiagnostics(string bicepFilePath, IContainerRegistryClientFactory clientFactory, ITemplateSpecRepositoryFactory templateSpecRepositoryFactory, PublicRegistryModuleIndexHttpClient? moduleMetadataClient = null)
        {
