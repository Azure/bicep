    ...
    ArmClient armClient)
{
    ...
    Such information is the most accurate and up-to-date as it is sourced from the Azure Resource Provider APIs.
    """)]
    public CallToolResult GetAzResourceTypeSchema(
    ...
    """)]
    public CallToolResult GetBicepBestPractices()
        => McpHelper.ExecuteWithFullErrorLogging(() => BestPracticesMarkdownLazy.Value.ToString());
    ...
    """)]
    public ValueTask<CallToolResult> GetBicepFileDiagnostics(
        [Description("The raw contents of the .bicep file")] string bicepContents)
        => McpHelper.ExecuteWithFullErrorLogging(async () =>
        {
    ...
    """)]
    public ValueTask<CallToolResult> GetBicepWhatIfResults(
