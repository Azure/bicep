...
namespace Bicep.LanguageServer.Providers
{
    ...
    public class BicepCompilationProvider : ICompilationProvider
    {
        ...
        {
            var compilation = new Compilation(featureProviderFactory, namespaceProvider, syntaxTreeGrouping, configurationManager, apiVersionProviderFactory, linterAnalyzer, modelLookup);
