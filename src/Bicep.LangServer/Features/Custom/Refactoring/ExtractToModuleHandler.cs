...
using Bicep.LanguageServer.Features.Custom;
...
namespace Bicep.LanguageServer.Features.Custom.Refactoring;
...
public class ExtractToModuleHandler : IJsonRpcRequestHandler<ExtractToModuleParams, ExtractToModuleResponse>
{
    ...
    private readonly ErrorHandlingHelper<ExtractToModuleResponse> helper;

    public ExtractToModuleHandler(ICompilationManager compilationManager, ILanguageServerFacade server)
    {
        this.compilationManager = compilationManager;
        this.helper = new ErrorHandlingHelper<ExtractToModuleResponse>(server.Window);
    }
