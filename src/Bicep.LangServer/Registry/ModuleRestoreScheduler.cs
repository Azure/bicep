...
namespace Bicep.LanguageServer.Registry
{
    public sealed class ModuleRestoreScheduler : IModuleRestoreScheduler, IAsyncDisposable
    {
        ...
        public void RequestModuleRestore(ICompilationManager compilationManager, DocumentUri documentUri, IEnumerable<(ISourceFile, ModuleDeclarationSyntax)> modules)
        {
            this.CheckDisposed();
