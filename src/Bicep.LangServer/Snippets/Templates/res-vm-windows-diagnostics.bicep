...
resource ${1:windowsVMDiagnostics} 'Microsoft.Compute/virtualMachines/extensions@2020-12-01' = {
  name: ${2:'name'}
  ...
  properties: {
    ...
    protectedSettings: {
      ...
      storageAccountKey: listkeys(resourceId('Microsoft.Storage/storageAccounts', ${3:'storageaccount'}), '2015-06-15').key1
      storageAccountEndPoint: reference(resourceId('Microsoft.Storage/storageAccounts', ${3:'storageaccount'}), '2015-06-15').primaryEndpoints.blob
    }
  }
}
