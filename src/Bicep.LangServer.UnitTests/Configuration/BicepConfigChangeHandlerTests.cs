...
namespace Bicep.LangServer.UnitTests.Configuration
{
    ...
    public class BicepConfigChangeHandlerTests
    {
        ...
        //     var bicepConfigChangeHandler = new BicepConfigChangeHandlingConfigurationManager(LinterRulesProvider,
        ...
        // private static Mock<ITelemetryProvider> CreateMockTelemetryProvider()
        // {
