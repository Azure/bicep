...
namespace Bicep.LangServer.UnitTests
{
    ...
    public class BicepCompilationProviderTests
    {
        ...
        public void Create_ShouldReturnValidCompilation()
        {
            ...
            var context = provider.Create(workspace, fileUri, ImmutableDictionary<ISourceFile, ISemanticModel>.Empty, new AuxiliaryFileCache(BicepTestConstants.FileResolver));
