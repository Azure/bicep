...
namespace Bicep.LangServer.UnitTests
{
    ...
    public class BicepCompletionProviderTests
    {
        ...
        public void DeclarationContextShouldReturnKeywordCompletions()
        {
            ...
            BicepCompletionProvider completionProvider = new(BicepTestConstants.FileResolver, snippetsProvider, compilation.NamespaceProvider, BicepTestConstants.MCRCompletionProvider);
