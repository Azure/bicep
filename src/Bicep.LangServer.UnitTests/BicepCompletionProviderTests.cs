...
namespace Bicep.LangServer.UnitTests
{
    ...
    public class BicepCompletionProviderTests
    {
        ...
        private static readonly SnippetsProvider snippetsProvider = new(TestTypeHelper.CreateEmptyProvider(), BicepTestConstants.FileResolver, BicepTestConstants.ConfigurationManager, BicepTestConstants.ApiVersionProvider);
        ...
        public void DeclarationContextShouldReturnKeywordCompletions()
        {
            ...
            var compilation = new Compilation(TestTypeHelper.CreateEmptyProvider(), grouping, BicepTestConstants.BuiltInConfiguration, BicepTestConstants.ApiVersionProvider);
