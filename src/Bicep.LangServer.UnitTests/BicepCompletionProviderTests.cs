...
namespace Bicep.LangServer.UnitTests
{
    ...
    public class BicepCompletionProviderTests
    {
        ...
        public async Task DeclarationContextShouldReturnKeywordCompletions()
        {
            ...
            BicepCompletionProvider completionProvider = new(BicepTestConstants.FileResolver, snippetsProvider, compilation.NamespaceProvider, BicepTestConstants.BicepModuleReferenceCompletionProvider);
