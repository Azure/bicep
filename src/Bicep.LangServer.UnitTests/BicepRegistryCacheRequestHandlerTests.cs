...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepRegistryCacheRequestHandlerTests
    {
        ...
        public async Task InvalidModuleReferenceShouldThrow()
        {
            ...
            dispatcher.Setup(m => m.TryGetArtifactReference(ModuleRefStr, "module", It.IsAny<Uri>())).Returns(ResultHelper.Create(null as ArtifactReference, x => x.ModuleRestoreFailed("blah")));
        ...
        public async Task LocalModuleReferenceShouldThrow()
        {
            ...
            dispatcher.Setup(m => m.TryGetArtifactReference(ModuleRefStr, "module", It.IsAny<Uri>())).Returns(ResultHelper.Create(outRef, failureBuilder));
        ...
        public async Task ExternalModuleNotInCacheShouldThrow()
        {
            ...
            dispatcher.Setup(m => m.TryGetArtifactReference(ModuleRefStr, "module", parentModuleUri)).Returns(ResultHelper.Create(outRef, failureBuilder));
        ...
        public async Task FailureToReadEntryPointShouldThrow()
        {
            ...
            ArtifactReference? outRef = moduleReference;
            dispatcher.Setup(m => m.TryGetArtifactReference(ModuleRefStr, "module", It.IsAny<Uri>())).Returns(ResultHelper.Create(outRef, null));
