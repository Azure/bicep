...
[TestClass]
public class VisualizerGraphDifferTests
{
    [TestMethod]
    public void Diff_against_null_current_adds_every_node_and_edge_parents_first()
    {
        ...
        var patches = VisualizerGraphDiffer.Diff(current: null, target);
    ...
    public void Diff_removes_nodes_absent_from_target_deepest_first()
    {
        ...
        var patches = VisualizerGraphDiffer.Diff(current, target);
