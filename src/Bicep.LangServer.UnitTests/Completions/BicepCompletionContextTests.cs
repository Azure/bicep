...
namespace Bicep.LangServer.UnitTests.Completions
{
    ...
    public class BicepCompletionContextTests
    {
        ...
        public void ZeroMatchingNodes_Create_ShouldThrow()
        {
            ...
            var compilation = new Compilation(BicepTestConstants.FeatureProviderManager, BicepTestConstants.NamespaceProvider, SourceFileGroupingFactory.CreateFromText(text, BicepTestConstants.FileResolver), BicepTestConstants.BuiltInOnlyConfigurationManager, BicepTestConstants.ApiVersionProvider, BicepTestConstants.LinterAnalyzer);
