  ...
  ""moduleAliases"": {
    ""br"": {
      ...
      ""test2"": {
        ...
        {
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IPublicRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetCachedModules()).Returns(new RegistryModule[] { new("app/dapr-cntrapp1", null, null), new("app/dapr-cntrapp2", "description2", "contoso.com/help2") });
    ...
    ""br"": {
      ...
      ""test2"": {
        ""registry"": ""mcr.microsoft.com""
            ...
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IPublicRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetCachedModuleVersions("app/dapr-containerapp")).Returns(new RegistryModuleVersion[] { new("1.0.2", null, null), new("1.0.1", "d2", "contoso.com/help%20page.html") });
        ...
        {
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IPublicRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetCachedModuleVersions("app/dapr-containerappapp")).Returns(new RegistryModuleVersion[]{});
    ...
    ""br"": {
      ...
      ""test2"": {
        ""registry"": ""mcr.microsoft.com""
            ...
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IPublicRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetCachedModules()).Returns(new RegistryModule[] { new("app/dapr-containerappapp", "dapr description", "contoso.com/help") });
    ...
    ""br"": {
      ...
      ""test4"": {
        ""registry"": ""mcr.microsoft.com""
            ...
            var publicRegistryModuleMetadataProvider = StrictMock.Of<IPublicRegistryModuleMetadataProvider>();
            publicRegistryModuleMetadataProvider.Setup(x => x.GetCachedModules()).Returns(new RegistryModule[] { new("app/dapr-cntrapp1", "description1", null), new("app/dapr-cntrapp2", null, "contoso.com/help2") });
