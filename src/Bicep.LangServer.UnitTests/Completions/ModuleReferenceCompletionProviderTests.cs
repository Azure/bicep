  ...
  ""moduleAliases"": {
    ...
    ""ts"": {
      ""mySpecRG"": {
        ...
        [TestMethod]
        public async Task GetExtendsSyntaxCompletions_WithCustomBicepConfig()
        {
            var bicepConfigFileContents = @"{
            ...
            var completionContext = GetBicepCompletionContext("extends |", bicepConfigFileContents, out DocumentUri documentUri);
            var moduleReferenceCompletionProvider = new ModuleReferenceCompletionProvider(
                azureContainerRegistriesProvider,
                new ConfigurationManager(new IOFileSystem()),
                publicRegistryModuleMetadataProvider,
