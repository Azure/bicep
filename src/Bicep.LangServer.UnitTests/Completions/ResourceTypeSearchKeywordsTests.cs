    ...
    public class ResourceTypeSearchKeywordsTests
    {
        ...
        [DataRow(
            ...
            """
                ...
                """,
            "res-app-plan,Application Service Plan (Server Farm),asp,appserviceplan,hostingplan,Microsoft.Web/serverfarms")]
        [DataRow(
            "res-app-plan",
            "Application Service Plan (Server Farm)",
            """
                ...
                """,
            "res-app-plan,Application Service Plan (Server Farm),asp,appserviceplan,hostingplan,Microsoft.Web/serverfarms,Microsoft.Web/unknown")]
        [DataRow(
