...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepBuildCommandHandlerTests
    {
        ...
        public void Handle_WithInvalidPath_ShouldThrowArgumentException(string path)
        {
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Serializer, EmitterSettingsHelper.DefaultTestSettings, BicepTestConstants.NamespaceProvider, FileResolver, ModuleDispatcher, configurationManager);
...
resource dnsZone 'Microsoft.Network/dnsZones@2018-05-01' = {
  ...
  location: 'global'
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Repository.Create<ISerializer>().Object, EmitterSettingsHelper.DefaultTestSettings, BicepTestConstants.NamespaceProvider, FileResolver, ModuleDispatcher, configurationManager);
            string expected = await bicepBuildCommandHandler.Handle(bicepFilePath, CancellationToken.None);
