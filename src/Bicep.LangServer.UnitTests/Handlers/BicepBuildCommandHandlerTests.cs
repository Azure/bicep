...
");
        ...
        public async Task Handle_WhenCompiledFileAlreadyExistsAndIsMalformed_ReturnsBuildFailedMessage()
        {
            ...
            expected.Should().Be(@"Build failed. The file ""input.json"" already exists and is malformed. If overwriting the file is intended, delete it manually and retry the Build command.");
        }
