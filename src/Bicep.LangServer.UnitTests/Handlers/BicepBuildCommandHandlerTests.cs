...
namespace Bicep.LangServer.UnitTests.Handlers
{
    ...
    public class BicepBuildCommandHandlerTests
    {
        ...
        public void Handle_WithInvalidPath_ShouldThrowArgumentException(string path)
        {
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Serializer, BicepTestConstants.FeatureProviderManager, BicepTestConstants.NamespaceProviderManager, FileResolver, ModuleDispatcher, BicepTestConstants.ApiVersionProviderManager, configurationManager);
...
resource dnsZone 'Microsoft.Network/dnsZones@2018-05-01' = {
  ...
  location: 'global'
            ...
            BicepBuildCommandHandler bicepBuildCommandHandler = new BicepBuildCommandHandler(bicepCompilationManager, Repository.Create<ISerializer>().Object, BicepTestConstants.FeatureProviderManager, BicepTestConstants.NamespaceProviderManager, FileResolver, ModuleDispatcher, BicepTestConstants.ApiVersionProviderManager, configurationManager);
            string expected = await bicepBuildCommandHandler.Handle(bicepFilePath, CancellationToken.None);
