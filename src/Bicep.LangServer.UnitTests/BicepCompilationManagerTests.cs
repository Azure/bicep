  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithEnabledSectionInPrevConfiguration_ShouldDoNothing()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithNoEnabledSectionInPrevConfigurationAndCurrentSettingIsFalse_ShouldFireTelemetryEvent()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithNoEnabledSectionInPrevConfigurationAndCurrentSettingIsTrue_ShouldDoNothing()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithNoEnabledSectionInCurConfigurationAndPreviousSettingIsFalse_ShouldFireTelemetryEvent()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithNoEnabledSectionInCurConfigurationAndPrevSettingIsTrue_ShouldDoNothing()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithEmptyCurConfig_ShouldUseDefaultSettingsAndFireTelemetryEvent()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithEmptyCurAndPrevConfig_ShouldDoNothing()
        {
            var compilationManager = CreateBicepCompilationManager();
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithOverallLinterSettingDisabledInBothPrevAndCurConfig_ShouldDoNothing()
        {
            var compilationManager = CreateBicepCompilationManager();
  ...
  ""analyzers"": {
    ""core"": {
      ...
      ""rules"": {
        ...
        [TestMethod]
        public void GetTelemetryEventsForBicepConfigChange_WithMismatchInRuleSettingsInPrevAndCurConfig_ShouldFireTelemetryEvent()
        {
            var compilationManager = CreateBicepCompilationManager();
