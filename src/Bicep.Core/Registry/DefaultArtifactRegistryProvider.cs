...
namespace Bicep.Core.Registry
{
    public class DefaultArtifactRegistryProvider : IArtifactRegistryProvider
    {
        ...
        public ImmutableArray<IArtifactRegistry> Registries(Uri templateUri)
        {
            ...
            builder.Add(new OciArtifactRegistry(this.fileResolver, this.clientFactory, features, configuration, serviceProvider.GetRequiredService<PublicRegistryModuleMetadataProvider>(), templateUri)); //asdfg2
