...
namespace Bicep.Core.Rewriters
{
    public static class RewriterHelper
    {
        ...
        {
            var semanticModel = new SemanticModel(prevCompilation, bicepFile, prevCompilation.SourceFileGrouping.FileResolver, prevCompilation.Configuration, prevCompilation.GetEntrypointSemanticModel().LinterAnalyzer);
