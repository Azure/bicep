...
namespace Bicep.Core.Utils
{
    ...
    {
        public static SyntaxTrivia? GetDisableNextLineDiagnosticFromPreviousLine(ProgramSyntax programSyntax, ImmutableArray<int> lineStarts, int position, out int previousLine)
        {
