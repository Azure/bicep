...
namespace Bicep.Core.Semantics.Namespaces
{
    public static class SystemNamespaceType
    {
        ...
        private static IEnumerable<FunctionOverload> GetSystemOverloads(IFeatureProvider featureProvider)
        {
            ...
            if (featureProvider.LambdasEnabled)
            {
                ...
                yield return new FunctionOverloadBuilder("filter")
                    ...
                    .WithRequiredParameter("lambda", OneParamLambda(LanguageConstants.Any, LanguageConstants.Bool), "The filtering function",
                ...
                yield return new FunctionOverloadBuilder("map")
                    ...
                    .WithRequiredParameter("lambda", OneParamLambda(LanguageConstants.Any, LanguageConstants.Any), "The mapping function",
                ...
                yield return new FunctionOverloadBuilder("sort")
                    ...
                    .WithRequiredParameter("lambda", TwoParamLambda(LanguageConstants.Any, LanguageConstants.Any, LanguageConstants.Bool), "The sorting function",
                ...
                yield return new FunctionOverloadBuilder("reduce")
                    ...
                    .WithRequiredParameter("lambda", TwoParamLambda(LanguageConstants.Any, LanguageConstants.Any, LanguageConstants.Any), "The reduce function",
