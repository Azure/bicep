...
public static class Ev2NamespaceType
{
    ...
    public static NamespaceType Create(string aliasName)
    {
        ...
        var configSpecType = new ObjectType(
            "ConfigSpec",
        ...
        var stageMapType = new ObjectType(
            "StageMap",
            TypeSymbolValidationFlags.Default,
            new[]
            {
        ...
        var serviceModelType = new ObjectType(
            "ServiceModel",
            TypeSymbolValidationFlags.Default,
            new[]
            {
        ...
        var rolloutSpecType = new ObjectType(
            "RolloutSpec",
            TypeSymbolValidationFlags.Default,
            new[]
            {
                        ...
                        new NamedTypeProperty("configuration", new ObjectType(
                            ...
                            new[]
                            {
                                new NamedTypeProperty("serviceScope", new ObjectType(
                                    ...
                                    new[]
                                    {
                                        new NamedTypeProperty("spec", configSpecType, Description: "The service scope configuration specification."),
                                ...
                                new NamedTypeProperty("serviceGroupScope", new ObjectType(
                                    ...
                                    new[]
                                    {
                                        new NamedTypeProperty("spec", configSpecType, Description: "The service group scope configuration specification."),
                                ...
                                new NamedTypeProperty("ringScope", new TypedArrayType(
                                    new ObjectType(
                                        ...
                                        new[]
                                        {
                                            ...
                                            new NamedTypeProperty("serviceLevelSpec", configSpecType, Description: "The common ring scope configuration specification across all service groups under the service."),
                                            new NamedTypeProperty("serviceGroupLevelSpec", configSpecType, Description: "The ring scope configuration specification for the current service group."),
        ...
        return new NamespaceType(
            ...
            [
                ...
                new(configSpecType.Name, configSpecType),
