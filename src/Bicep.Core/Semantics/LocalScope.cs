...
namespace Bicep.Core.Semantics
{
    ...
    /// </summary>
    public class LocalScope(string name, SyntaxBase declaringSyntax, SyntaxBase bindingSyntax, IEnumerable<DeclaredSymbol> locals, IEnumerable<LocalScope> childScopes, ScopeResolution scopeResolution) : Symbol(name), ILanguageScope
    {
        ...
        public SyntaxBase BindingSyntax { get; } = bindingSyntax;

        public ImmutableArray<DeclaredSymbol> Locals { get; } = locals.ToImmutableArray();

        public ImmutableArray<LocalScope> ChildScopes { get; } = childScopes.ToImmutableArray();
        ...
        public ScopeResolution ScopeResolution { get; } = scopeResolution;
    }
}
