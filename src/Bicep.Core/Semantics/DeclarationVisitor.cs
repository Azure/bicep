...
namespace Bicep.Core.Semantics
{
    public sealed class DeclarationVisitor : AstVisitor
    {
        ...
        public override void VisitImportDeclarationSyntax(ImportDeclarationSyntax syntax)
        {
            ...
            else if (namespaceProvider.TryGetNamespace(syntax.Specification.Name, syntax.Alias?.IdentifierName ?? syntax.Specification.Name, targetScope, features, syntax) is not { } namespaceType)
            {
