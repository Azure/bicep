...
namespace Bicep.Core.Parsing
{
    public abstract class BaseParser
    {
        ...
        protected static RecoveryFlags GetSuppressionFlag(SyntaxBase precedingNode, bool predicate)
        {
        ...
        protected static ExpressionFlags WithoutExpressionFlag(ExpressionFlags flags, ExpressionFlags unset)
        {
            return flags & ~unset;
        }
        ...
        protected SyntaxBase ParenthesizedExpression(ExpressionFlags expressionFlags)
        {
