...
namespace Bicep.Core {
    ...
    internal class CoreResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Readonly resources can only be used with the &apos;existing&apos; keyword..
        /// </summary>
        internal static string NoWritingReadonlyResourcesDescription {
            get {
                return ResourceManager.GetString("NoWritingReadonlyResourcesDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Resources of type &apos;{0}&apos; can only be used with the &apos;existing&apos; keyword..
        /// </summary>
        internal static string NoWritingReadonlyResourcesMessageFormat {
            get {
                return ResourceManager.GetString("NoWritingReadonlyResourcesMessageFormat", resourceCulture);
            }
        }
