...
namespace Bicep.Core
{
    public static class LanguageConstants
    {
        ...
        public static readonly TypeSymbol StringFolderPath = TypeFactory.CreateStringType(validationFlags: TypeSymbolValidationFlags.IsStringFilePath | TypeSymbolValidationFlags.IsStringFolderPath);
