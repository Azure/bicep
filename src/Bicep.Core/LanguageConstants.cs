...
namespace Bicep.Core
{
    public static class LanguageConstants
    {
        ...
        public const string DisableDiagnostic = "bicep.DisableDiagnostic";
        ...
        public static readonly ImmutableSortedSet<string> DisableDiagnosticsKeywords = new[] { DisableNextLineDiagnosticsKeyword }.ToImmutableSortedSet(StringComparer.Ordinal);
