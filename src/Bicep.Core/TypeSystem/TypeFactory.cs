...
public static class TypeFactory
{
    ...
    public static TypeSymbol CreateStringType(long? minLength = null, long? maxLength = null, Regex? pattern = null, TypeSymbolValidationFlags validationFlags = TypeSymbolValidationFlags.Default)
    {
        if (maxLength.HasValue && maxLength.Value == 0)
        {
        ...
        if (minLength != UnrefinedString.MinLength || maxLength != UnrefinedString.MaxLength || pattern != UnrefinedString.Pattern || validationFlags != UnrefinedString.ValidationFlags)
        {
