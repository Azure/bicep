...
# ./bcode.ps1 src/Bicep.Core.TestFiles/Files to open VSCode in the Examples folder running your local bicep lang server and in vscode terminal you have access to your local bicep CLI build

$ENV:BICEP_LANGUAGE_SERVER_PATH=[System.IO.Path]::Join($PSScriptRoot,"..\src\Bicep.LangServer\bin\Debug\net7.0\Bicep.LangServer.dll")
