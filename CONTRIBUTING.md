...
* A snippet should either be a single, generic resource or follow [parent-child syntax](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/child-resource-name-type). Ensure your snippet meets this criteria.
